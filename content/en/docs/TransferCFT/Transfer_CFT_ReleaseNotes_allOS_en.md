...
## <span id="Platform"></span>Platform features
...
<th colspan="5">  OS </th>
      ...
      <tr data-mc-conditions="">
         <td colspan="6">
<p colspan="3"><sup>1</sup>Enabled for all UNIX except SCO, UnixWare, IRIX, Tru64.</p>
<p colspan="3"><sup>2</sup> Enabled only for Linux-x86-32, Linux-x86-64, Linux-ia64-64.</p>
<p colspan="3"><sup>3</sup>Enabled   for versions 3.0.1 to 3.3.2 on Windows 32-bit systems. As of Transfer CFT 3.4, Trusted File is supported on Windows 64-bit systems.</p>
<p colspan="3"><sup>4</sup>Limited to USS (z/OS) and IFS (IBM i) systems. On IBM i, native files folder monitoring is available for Transfer CFT 3.3.2 SP2 and higher.</p>
<p colspan="3"><sup>5</sup>Available on AIX, HPUX ia64, Linux, Solaris, Windows</p>
<p colspan="3"><sup>6</sup>For UNIX type files only</p>
         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <thead>
      <tr>
         <th>Functionality</th>
         <th>
            <p>Central Governance <br/><span> or Flow Manager </span></p>
</th>
         <th>
            <p>Transfer CFT user interface <br/></p>
</th>
      </tr>
   </thead>
   <tbody>
...
## <span id="Deprecat"></span>Deprecated functions
...
## <span id="Not supported"></span>Discontinued support
...
## <span id="Support"></span>Support services
