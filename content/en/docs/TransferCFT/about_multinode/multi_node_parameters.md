...
This section presents the **multi-node** parameters and their default values. The column <span>Modify </span>indicates a strong recommendation that you should not modify this value if <span>No </span>is indicated.
...
<p>If <span>Transfer CFT</span> is using NFSv4, you must enter the value <span>nfs </span>in lower case.</p></td>
<td><p>unknown</p></td>
...
<td><p><span>Transfer CFT</span> status</p></td>
<td><p>STOPPED</p></td>
<td><p>INITIALIZING,</p>
...
<td><p>Sets flag when disabling <span>Transfer CFT</span>.</p></td>
<td><p>No</p></td>
<td><p>Yes, No</p></td>
<td>No</td>
</tr>
...
-   [Multi-node commands](multi_node_commands.htm)

-   [Managing multi-node](set_up_multinode.htm)

-   [UCONF: Protocols and networks](../uconf/uconf_protocols_and_networks.htm)
