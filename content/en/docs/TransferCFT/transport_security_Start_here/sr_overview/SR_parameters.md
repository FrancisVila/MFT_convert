...
This parameter is specific to each <span>Transfer CFT</span> using the Router Agent.
<p>If more than one <span>Transfer CFT</span> uses the same Router Agent, each <span>Transfer CFT</span> must have a unique value.</p></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td><p>secure_relay.ra = n (number of Router Agents)</p>
...
<p> </p>
<p>CFTPART id=part,nspart=myself,srdmz=DMZ&lt;i&gt; (where i is the Router Agents to be used for the outgoing connection)</p></td>
</tr>
</tbody>
</table>
