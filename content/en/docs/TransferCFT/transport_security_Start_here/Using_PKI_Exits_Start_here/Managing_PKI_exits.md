...
## <span id="PKI_exit_fields"></span>PKI exit fields
...
## <span id="Creating_an_SSL_task"></span>Creating an SSL task
...
## <span id="Terminating_an_SSL_task"></span>Terminating an SSL task
...
## <span id="Opening_an_SSL_task"></span>Opening an SSL task
...
## <span id="Getting_a_CA_list_to_be_sent"></span>Sending a CA list
...
### <span id="Getting_a_certificate_to_be_sent"></span>Getting a certificate to be sent
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>handshake_failure(40)          bad_certificate(42)          unsupported_certificate(43)<br/>certificate_revoked(44)          certificate_expired(45)          certificate_unknown(46)<br/>illegal_parameter     (47)          unknown_ca(48)          access_denied(49)<br/>decode_error(50)               
 decrypt_error(51)          export_restriction(60)<br/>insufficient_security(71)          internal_error(80)          user_canceled(90)         </td>
      </tr>
   </tbody>
</table>
...
### <span id="Alert_during_the_handshake_phase"></span>Alert during the handshake phase
...
### <span id="Session_established_end_of_handshake"></span>Session established end-of-handshake
...
### <span id="Releasing_an_SSL_session"></span>Releasing an SSL session
...
### <span id="SSL_session_context"></span>SSL session context
