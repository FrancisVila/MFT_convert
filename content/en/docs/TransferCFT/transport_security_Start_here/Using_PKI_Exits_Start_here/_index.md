...
A sample of how to generate this exit is located in the <span class="code">&lt;cft.runtime\_dir>/src/exit</span> directory. You can invoke a makefile to generate this DLL (among other things) from the <span class="code">cftpkie.c</span> source file located in the same directory. Before calling this makefile, load the Transfer CFT profile.
...
In addition to the information found in this User Guide, the <span class="code">&lt;cft.install\_dir>/inc/cftpkie.h</span> file contains all the definitions required to develop a user function, such as constants, communication structure definition, and comments.
