...
- [Define rights before starting the {{< TransferCFT/axwayvariablesComponentShortName >}} UI server (Copilot)](#Define%20rights%20before%20starting%20the%20CFT%C2%A0Navigator%20server)
- [Define rights before logging on the {{< TransferCFT/axwayvariablesComponentShortName >}} UI server (Copilot)](#Define%20rights%20before%20logging%20on%20the%20CFT%C2%A0Navigator%20server)
