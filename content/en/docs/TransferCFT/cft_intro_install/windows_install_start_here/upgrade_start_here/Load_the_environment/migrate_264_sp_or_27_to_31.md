...
1.  Load the former Transfer CFT environment. See the [Migration prerequisites](transfercft/cft_intro_install/windows_install_start_here/upgrade_start_here/load_the_environment) for details.
