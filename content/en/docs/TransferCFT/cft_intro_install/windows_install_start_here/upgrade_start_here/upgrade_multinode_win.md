...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Remember that <span>Transfer CFT</span> clusters must be fully stopped while performing an upgrade.         </td>
      </tr>
</table>
...
3.  <table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>.\Transfer_CFT_<span>3.9</span>_Install_win-x86-64_&lt;BN&gt;.exe --architecture first_host --installdir &lt;installdir&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
4.  For each additional host, connect to the machine and execute the following command:  
   ...
   <tbody>
      <tr>
         <td>
            <p>.\Transfer_CFT_<span>3.9</span>_Install_win-x86-64_&lt;BN&gt;.exe --architecture additional_host --runtimedir &lt;runtimedir&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
1.  Launch the Transfer CFT profile from the Transfer CFT runtime directory on the shared disk.  
   ...
   <tbody>
      <tr>
         <td>
               <li>cd /&lt;shared_disk&gt;/&lt;CFTdir&gt;/Transfer_CFT/runtime<br/>profile.bat               </li>
         </td>
      </tr>
   </tbody>
</table>
