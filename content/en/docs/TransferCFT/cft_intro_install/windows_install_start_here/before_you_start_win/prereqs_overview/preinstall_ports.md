...
- Copilot: Provides access to Transfer CFT{{< TransferCFT/componentshortname >}} UI server from a user Internet browser
- Copilot for Central Governance{{< TransferCFT/centralgovernancename >}}: Provides secure access for Central Governance (mutual authentication)
