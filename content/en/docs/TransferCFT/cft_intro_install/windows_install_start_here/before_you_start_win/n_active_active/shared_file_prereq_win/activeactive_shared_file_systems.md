...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You should configure the lease time  together with the UCONF <span>copilot.node_manager.watchperiod</span> parameter, noting the restriction that NFS lease time &gt; 2 * <span>copilot.node_manager.watchperiod</span>.         </td>
      </tr>
</table>
