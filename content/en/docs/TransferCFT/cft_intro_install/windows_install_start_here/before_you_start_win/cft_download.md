...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">On Windows systems, see the <a href="../prereqs_overview2/preinstall_win" xrefformat="{paratext}"></a> for  prerequisites including DLL requirements for x86.         </td>
      </tr>
</table>
