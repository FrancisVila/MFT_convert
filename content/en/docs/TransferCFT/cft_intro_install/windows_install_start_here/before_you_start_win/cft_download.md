...
The installation package is a zip archive. It contains the product, a configuration template file called <span class="code">`initialize.properties`</span>, and the installation program files. For details on customizing the template file, see <a href="../../../unix_install_start_here/before_you_start_unix/new_install_ux" class="MCXref xref">Customize the initialize.properties file</a>
