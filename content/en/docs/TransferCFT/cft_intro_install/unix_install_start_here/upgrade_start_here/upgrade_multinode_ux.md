...
3.  <table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>./Transfer_CFT_<span>3.9</span>_Install_&lt;OS&gt;_&lt;BN&gt;.run --architecture first_host --installdir &lt;installdir&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
4.  For each additional host, connect to the machine and execute the following command:  
   ...
   <tbody>
      <tr>
         <td>
            <p>./Transfer_CFT_<span>3.9</span>_Install_&lt;OS&gt;_&lt;BN&gt;.run --architecture additional_host --runtimedir &lt;runtimedir&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
1.  Launch the Transfer CFT profile from the Transfer CFT runtime directory on the shared disk of each machine.  
   ...
   <tbody>
      <tr>
         <td>
               <li>cd /&lt;shared_disk&gt;/&lt;CFTdir&gt;/Transfer_CFT/runtime<br/>.  ./profile                </li>
         </td>
      </tr>
   </tbody>
</table>
