...
`chmod +x Transfer_CFT_3.9{{< TransferCFT/releasenumber >}}_Install_<OS>_<BN>.run`
...
| License agreement  | Select the check-box "I accept..." to continue with the installation.  |
