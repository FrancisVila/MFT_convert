...
By default, the shared file system is set to <span class="code">unknown</span>, the value to use for GPFS. If you are uncertain as to the file system setting for the Transfer CFT internal data files, execute the following command to return to the default setting:<span class="code">  
...
Enter the <span class="code">nfs </span>value in lower case:<span class="code">  
</span>
...
1.  Stop the <span class="mc-variable suite_variables.TransferCFTName variable">Transfer CFT</span> cluster.
2.  Perform the failover.
3.  Start the <span class="mc-variable suite_variables.TransferCFTName variable">Transfer CFT</span> cluster.
