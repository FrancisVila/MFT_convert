...
#  
.doc=O           # MS-DOS
text file (param.doc for example)  
.txt=T          
# UNIX text file(cft.txt for example)  
\*.bin=B          #
Binary file (fil.bin for example)  
\*.dat?=B     # Binary
file (john.dat0,fred.data for example)

          #
...

### <span id="Enabling"></span>Enabling suffix management
...
## <span id="Separati"></span>Separating file name extensions
