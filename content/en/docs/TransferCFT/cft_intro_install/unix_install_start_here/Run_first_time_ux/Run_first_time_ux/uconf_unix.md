   ...
   <tbody>
      ...
      <tr class="odd">
         ...
         <td>Specify the absolute path name to the CFTSU to execute when the user control is enabled, to enable upgrading without being the system administrator.
            <p>See Unix: <a href="../UNIX/t_adding_system_user_unix.htm">Using system users</a>.</p>         </td>
      </tr>
   </tbody>
</table>
...
See [Suffix management](../UNIX/UNIX_operations/Running_CFT/suffix_management.htm).
