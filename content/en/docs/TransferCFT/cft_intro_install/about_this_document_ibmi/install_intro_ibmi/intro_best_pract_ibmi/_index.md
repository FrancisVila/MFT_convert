...
-   [Starting the Transfer CFT <span class="mc-variable Primary.For_OS400 variable">Transfer CFT IBM i</span> Manager](../../post_install_intro_ibmi/start_cft_ibmi_manager)
...
-   [Using CFTUTIL <span class="mc-variable Primary.For_OS400 variable">Transfer CFT IBM i</span> specific commands](using_cftutil)
