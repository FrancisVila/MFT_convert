...
-   Native: On the Transfer CFT default [subvolume](#): CTMPnnnn
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>The default working directory for the TACL and NETBATCH scripts.</p>
            <p>The parameter is set with the default value of “<span>&lt;</span><span data-xmlns="http://www.w3.org/TR/REC-html40">subvolume</span><span>&gt;UD</span>”
(see <a href="#">Guardian files</a>) during the Guardian
