...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You can uninstall an upgrade if needed. However, doing so rolls back to the previous version before the upgrade, so all transfers and configuration modifications that were performed since the upgrade are lost.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You cannot migrate the Transfer CFT Guardian 2.3.2 catalog and communication files to Transfer CFT HP NonStop <span>3.9</span>.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   <col/>
      <tr>
         <td>
            <p>KW     Type    Volume.Subvolume</p>
            <p><a href="#cftwrk">CFTWRK</a>  default $DATA00.CFT232UD</p>
         </td>
      </tr>
      <tr>
         <td>
            <p> KW   AP  <a href="#cpu">CPU</a> PNL SMS  MMS <a href="#term">TERM</a>    IN       COL  SWAPF    MEAS  <a href="#cpubackup">CPUBACKUP</a></p>
            ...
            <p>CFTAPP 4  0   X  0    0   default default  $0   none     X     X</p>
         </td>
      </tr>
      <tr>
         <td>
            <p>KW      AP  LMS  ID       <a href="#pn">PN</a>     <a href="#pri">PRI</a> CPU  OBJECT                  OUT</p>
      ...
      <tr>
         <td>
            ...
            <p>CFTDEF  CFTHOBJ   $DATA00.monfiles.SECFROBJ</p>
         </td>
      </tr>
      <tr>
         <td>
            <p>KW     <a href="#manager">MANAGER</a>   <a href="#nb">NB-ATTACH-SET</a></p>
            <p>CFTBT    TACL     NBASCFTLI</p>
         </td>
      </tr>
      <tr>
         <td>
            ...
            <p>TCPPARM  TCPIP^PROCESS^NAME^2  $ZTC0</p>
         </td>
      </tr>
      <tr>
         <td>
            <p>KW       PARM                  VAL</p>
            <p><a href="#x25param">X25PARM</a>  X25^CNX^TIME^OUT       40</p>
         </td>
      </tr>
      <tr>
         <td>
            ...
            <p>NONSTOP^PLIST^TEMP^FILE         $DATA00.montemp.PTMPLIST</p>
         </td>
      </tr>
</table>
