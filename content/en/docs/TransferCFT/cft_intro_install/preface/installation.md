...
<p>CFTPLATE contains the Transfer CFT templates to be concatenated with the system template for an EMS collector. See the XCFTDDL section in <a href="../intro_os_features/ems_templates">Event messages</a>, which describes the DDL template.</p></td>
</tr>
<tr class="odd">
<td>&lt;subvolume&gt;IX</td>
