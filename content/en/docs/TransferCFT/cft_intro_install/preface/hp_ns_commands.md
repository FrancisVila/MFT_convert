...
Prior to executing Transfer CFT commands, you must install them. If you have not already done so, perform the task as described in [Install the Guardian specific files](../installation).
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>$ YOURCO HOME &gt; volume $DATA14.CFT32AIX</p>
            <p>$DATA14 CFT32AIX 1&gt; <b>CFTUTIL</b></p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>$SAS51 FORD36IX 3&gt; push CFT^UTLOUT</p>
            ...
            <p>$SAS51 FORD36IX 9&gt; pop CFT^UTLOUT</p>
         </td>
      </tr>
   </tbody>
</table>
