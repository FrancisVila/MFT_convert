...
For more information, see [CFTPARM](../../../../c_intro_userinterfaces/about_cftutil/configuring_cft_start_here/cftparm).
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top"><span>Transfer CFT</span> z/OS accepts passwords in lower case using RACF or Top-Secret.         </td>
      </tr>
   </tbody>
</table>

### <span id="RACF pas"></span>RACF password phrase support

Transfer CFT supports the use of a password phrase (RACF) in the user interface, JPIUTIL, REST API, and synchronous API services.
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>PERMIT PBX.SERVER CLASS(FACILITY) ID(CFT) ACCESS(READ)
            <p>ID(COPILOT)</p>         </td>
      </tr>
   </tbody>
</table>
