{
    ...
    "weight": "270"
}When running under Central Governance, you can use but not manage your Transfer CFT{{< TransferCFT/transfercftname  >}} exits. To manage exits, use the information to manually configure as described in this section.
