...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">An APF allows an installation to identify system or user programs that can use sensitive system functions.         </td>
      </tr>
   </tbody>
</table>
