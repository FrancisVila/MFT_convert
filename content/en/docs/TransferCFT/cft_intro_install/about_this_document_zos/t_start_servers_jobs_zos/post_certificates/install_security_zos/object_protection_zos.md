...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>CFTPARM.IDPARM0<br/>      CFTSEND.DEFAULT     <br/>      CFTRECV.DEFAULT     <br/>      CFTAPPL.DEFAULT            </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>CFTPARM.IDPARM0    USER(usercmd)  ACCESS(create)</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>ALL_PARM.CFTV2.PARM   USER(usercmd)  ACCESS(read)</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RDEFINE safcftcl    CFTRECV.DEFAULT UACC(NONE) OWNER( grpcft )<br/>PERMIT   CFTRECV.DEFAULT   CLASS( safcftcl )    ACCESS(CONTROL) -<br/>ID( grpcft   grpaprm   usera   userb   and so on  )<br/>CONNECT   usera   GROUP( grpfprm ) OWNER( grpcft )<br/>CONNECT   userb   GROUP( grpfprm ) OWNER( grpcft )</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>CFTPARM ID=IDPARM0,DEFAULT=DEFAULT, …</p>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">As end-of-transfer commands are submitted from the transfer owner account (Usrtso2), these procedures cannot execute certain commands (DELETE, START, KEEP, and so on) unless the USRTSO2 user corresponds to a RACF profile type:<br/>PERMIT APPL.TEXT CLASS(safcftcl) ID(usrtso2) ACCESS(CONTROL)<br/>or<br/>PERMIT ALL_CAT.** CLASS(safcftcl) ID(usrtso2) ACCESS(CONTROL)         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>SEND IDF=TEXT,PART=BANK,FNAME=CFTV2.TEST.CHECK</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RECV IDF=TEXT,PART=BANK,FNAME=CFTV2.TEST.CHECK</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RDEFINE safcftcl TRANSFER.TEXT.R.BANK UACC(NONE) OWNER(GRPCFT)</p>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RDEFINE safcftcl MESSAGE.TEXT.S.BANK UACC(NONE) OWNER(GRPCFT)</p>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RECV IDM=TEXT, TYPE=REPLY, PART=BANK, IDT= C3110510, MSG='ACKNOWLEDGED'</p>
         </td>
      </tr>
   </tbody>
</table>
   ...
   <tbody>
      <tr>
         <td>
            <p>RDEFINE safcftcl MESSAGE.TEXT.S.BANK UACC(NONE) OWNER(GRPCFT)</p>
            <p>PERMIT MESSAGE.TEXT.S.BANK CLASS(safcftcl) –</p>
            <p>ID(Usrtso2 GRPTRF) ACCESS(CONTROL)</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>RDEFINEsafcftcl MESSAGE.TEXT.R.BANK UACC(NONE) OWNER(GRPCFT)</p>
            <p>PERMIT MESSAGE.TEXT.R.BANK CLASS(safcftcl) –</p>
            <p>ID(Usrtso3) ACCESS(CONTROL)</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Objects whose VALUE parameter contains the &amp;FNAME variable generate a resource name that takes into account the physical file name. RACF profiles must anticipate the differing cases, in particular PDS or GDG members.         </td>
      </tr>
</table>
