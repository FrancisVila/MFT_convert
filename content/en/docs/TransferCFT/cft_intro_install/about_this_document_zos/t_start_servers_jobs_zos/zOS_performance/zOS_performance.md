...
## <span id="Disk input/output"></span>Disk input/output
...
## <span id="DF/SMS compression"></span>DF/SMS compression
...
## <span id="Automatic Restart Manager services"></span>Automatic Restart Manager Service
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top"> The LOWPORT parameter is deprecated.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">For ascending compatibility with Transfer CFT parameters, LOWPORT=0 (or 1) is still supported in the CFTNET and will automatically set the SRCPORTS with the correct value, but only if it is not already set in the macro!         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">To avoid TCP/IP source port conflict with Sentinel,  see the Sentinel Configuration instructions.         </td>
      </tr>
</table>
