{
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Do not use a dash "-" as a special character in z/OS (MVS) file names. This is an invalid system character.         </td>
      </tr>
</table>
...
## <span id="Share Transfer CFT files"></span>Share Transfer CFT files
