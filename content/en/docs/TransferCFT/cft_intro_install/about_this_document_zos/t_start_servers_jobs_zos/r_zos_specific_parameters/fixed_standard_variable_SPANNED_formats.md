...
It is not typically mandatory to switch users to release a resource. To activate a switch during FREE, set the <span class="code">..UPARM(CNFENV) FREE\_AS\_USER</span> variable to 1.
