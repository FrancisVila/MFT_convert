...
<table>
   <tbody>
      <tr>
         ...
         <td>Customize variables before submitting the JCL.         </td>
      </tr>
   </tbody>
</table>
...
<table>
   <tbody>
      <tr>
         <td>         </td>
         <td><span><strong>Note</strong></span>         </td>
         <td>ZFS file creation is not taken into account in this process.         </td>
      </tr>
   </tbody>
</table>
...
<table>
   <tbody>
      <tr>
         <td>         </td>
         <td><span><strong>Note</strong></span>         </td>
         <td>Save the Transfer CFT LOAD, as well as the Copilot USS environment prior to applying a patch.         </td>
      </tr>
   </tbody>
</table>
