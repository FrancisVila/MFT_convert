...
Use the A13RBACK to restore the executable file library, USS Copilot and USS Secure Relay{{< TransferCFT/securerelayname  >}} environment. This JCL executes the following three JCLs:

- A13RSTOR: Restores the Transfer CFT Load library.
- A13UCOPR: Restores the Transfer CFT USS Copilot environment.
- A13UXSRR: Restores the Transfer CFT USS Secure Relay{{< TransferCFT/securerelayname >}} environment.
...
- Stop Transfer CFT and Copilot{{< TransferCFT/copilotname >}}.
