{
    ...
    "linkTitle": "Upgrade",
    "weight": "220"
}This section describes how to upgrade to <span class="mc-variable axway_variables.Release_Number variable">3.9</span> and higher (from versions 3.1.3, 3.2.x, 3.3.x, 3.4, 3.5).
...
<table>
   <tbody>
      <tr>
         ...
         <td>The MIGRCAT procedure migrates the catalog files, one catalog file at a time. You must modify and execute this procedure for each node.         </td>
      </tr>
   </tbody>
</table>
...
<table>
   <tbody>
      <tr>
         <td>         </td>
         <td><span><strong>Note</strong></span>         </td>
         <td>The JCL MIGRUCNF was fixed in 3.6 SP3.         </td>
      </tr>
   </tbody>
</table>
