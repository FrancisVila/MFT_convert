...
## <span id="Copy"></span>Copy the JCLs to upgrade
...
## <span id="Upgrade"></span>Upgrade the target instance (product environment)
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The MIGRCAT procedure migrates the catalog files, one catalog file at a time. You must modify and execute this procedure for each  node.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The JCL MIGRUCNF was fixed in 3.6 SP3.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note  &lt;/b&gt;" valign="top">The UNCONFSET commands are defined in UPARM(COPCFG) and the JCL to be submiited is COPA020.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>// SET DISTLIB=&amp;CFTENV</p>
               <li>// SET DISTPRF= -&gt; &amp;CFTENV without the last qualifier       <br/>// SET DISTLVL= -&gt; last qualifier of &amp;CFTENV                </li>
            <p>For example if CFTENV=XX.YY.ZZ </p>
               <li>// SET DISTLIB=&amp;CFTENV or XX.YY.ZZ <br/>// SET DISTPRF=XX.YY      <br/>// SET DISTLVL=ZZ                 </li>
         </td>
      </tr>
   </tbody>
</table>
