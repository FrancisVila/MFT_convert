{
    ...
    "weight": "240"
}## Using <span id="kanchor43"></span>COPA020
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The parameters file linked to the UI configuration for Transfer CFT V2.4.x can be partially migrated to the unified configuration file (see      <a href="t_migrate_cft_files.htm">Transfer CFT file migration</a>).          </td>
      </tr>
</table>
