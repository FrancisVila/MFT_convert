...
## Customize parameters in <span id="kanchor27"></span>the JCL
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>The password, required to generate the key for installation, is temporarily stored in the 'pswfname' file (and is removed after installation).</p>
            <p><strong>Syntax</strong>: <span>--pass &lt;password&gt;</span></p>         </td>
      </tr>
      <tr class="even">
         <td>keyfname         </td>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         <td>            <p>copenable</p>         </td>
         <td>'yes'         </td>
         <td>            <p>Enable the <span>Transfer CFT</span> <span>Copilot</span> server.</p>         </td>
      </tr>
      <tr class="even">
         <td>            <p>copladdr</p>         </td>
         <td>'&amp;&amp;HOSTBYADDR'         </td>
         <td>            <p>Transfer CFT <span>Copilot</span> server TCP/IP address. The key word '&amp;&amp;HOSTBYADDR' is substituted by the result of the REXX function socket ("GETHOSTBYADDR"). (copilot.general.serverhost)</p>         </td>
      </tr>
      <tr class="odd">
         <td>            <p>coplport</p>         </td>
         <td>'1766'         </td>
         <td>            <p>Transfer CFT <span>Copilot</span> listening port (copilot.general.serverport).</p>         </td>
      </tr>
      <tr class="even">
         <td>coplsslp         </td>
         <td>'1767'         </td>
         <td>            <p>Copilot server SSL listening port.
*Mandatory for <span>Central Governance</span> (copilot.general.ssl_serverport).</p>         </td>
      </tr>
      <tr class="odd">
         <td>coppath         </td>
...
Use these parameters only with the Transfer CFT z/OS security setup described in [Setting up RACF Security](../operator_interface_commands/t_set_%20up_RACF_security.htm).
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">Read only, you can share the directory with other Transfer CFTs.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
      <tr class="odd">
         ...
         <td>Runtime directory for Secure Relay Master Agent; one per instance, with Read/Write rights for <span>Transfer CFT</span>.         </td>
      </tr>
      <tr class="even">
         <td>srmacopo         </td>
         <td>'srmacopo'         </td>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top"><span>(1) The UCONF and UCONFRUN files are created at the same time as the instance environment, so you must manually re-create when a specific prefix is used (recfm= VB, lrecl=2048).</span>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value 'ARM=NO'.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value 'BLKSIZE=27998'.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">If a Transfer CFT EXEC procedure is HSM migrated, it is not executed. An error message indicating this is displayed in the Transfer CFT LOG: CFTS02E migrated.         </td>
      </tr>
   </tbody>
</table>
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value ‘HSMASYNC=YES’.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">On a shared SYSPLEX you must customize the following z/OS system parameter, either:         </td>
      </tr>
   </tbody>
</table>
            <ul>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value ‘PDSESHARING=YES’.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
      ...
      <tr class="even">
         ...
         <td>            <ul>
            ...
            <ul>
               <li>            <p>If the catalog is full and an extension is created (using either the <span>cft.cftcat.auto_expand_*</span> parameters or <span>RECONFIG TYPE=CAT</span>), new records are stored in the extension and not in the cache. Accessing records in the extension may negatively impact performance.</p>               </li>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">When the Transfer CFT is an APF-authorized program (Authorized Program Facility), specify if the catalog dataspace cache is available to be read by other Transfer CFT applications.         </td>
      </tr>
   </tbody>
</table>
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value ‘SHARECAT=YES’.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">When you use the SGTRACE options with the Transfer CFT interface under VTAM, the non-encrypted passwords are listed in the trace records.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value ‘TAPE=OUTPUT’.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">The delivered sample uses the value ‘TSOEDIT=YES’.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
      <tr class="even">
         ...
         <td>            <ul>
            ...
            <p>Alternatively, you can set this parameter using: <span>UCONFSET ID=cft.mvs.sginstal.vsamsufs,value=x</span></p>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">*MCSOPT, SDSFOPT, EMCSOPT: A user id is added only to CFTUTIL commands. The z/OS PAUSE command is interpreted as a CFTUTIL SHUT FAST=YES command. Transfer CFT diagnosis commands are not associated with a used id, for example MODIFY cft or ECHO.         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>CFTI18I+Installation options (macro SGINSTAL)</p>
            <p>CFTI18I+ Macro date - 05/29/17 15.45 (MM/DD/YY hh.mm) (c)</p>
            <p>CFTI18I+ SHARECAT=NO
CFTI18I+ TAPE=UPDATE
CFTI18I+ BLKSIZE=27998</p>
            <p>CFTI18I+ BLKPDS=200
CFTI18I+ HSMASYNC=YES</p>
            <p>CFTI18I+ ALLPRIM=100,ALLSEC=10,VOLNUM=20,ALLONE=100,ALLNEX=100</p>
            <p>CFTI18I+ …</p>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>//* <strong>STEP 1 : GENERATE</strong></p>
            ...
            <p>// SPACE=(TRK,(1)),</p>
            <p>// DSN=&amp;&amp;TMP</p>
            <p>//* <strong>STEP 2 : UPDATE UCONF</strong></p>
            <p>//UCONF EXEC PCFTUTL,PARM=''</p>
            <p>//CFTIN DD DISP=(OLD,DELETE),</p>
            <p>// DSN=&amp;&amp;TMP</p>
            <p>Delivered JCL INSTALL(MIGRSGI) extract.</p>         </td>
      </tr>
   </tbody>
</table>
...
[Customize JCL installation files](Installation_parameters_to_customize.htm)
