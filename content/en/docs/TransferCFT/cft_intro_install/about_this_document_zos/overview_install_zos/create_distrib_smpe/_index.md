...
You can download the SMP/E distribution file <span class="code">`Transfer_CFT_3.3.x_install_mvs_BNnnnnnnn.smpe.zip`</span> to your computer (Windows or Unix) from [Axway Sphere](https://www.support.axway.com/).
