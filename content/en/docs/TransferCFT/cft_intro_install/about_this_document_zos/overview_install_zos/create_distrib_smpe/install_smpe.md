...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>
            <ul>
            <p>T = Type of function </p>
            <p>CF0 = Component Code for Transfer CFT </p>
            <p>300 = Release 3.3.2</p>
            </ul>
         </td>
      </tr>
   </tbody>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>Dataset name for the product SMPE samples </p>
         </td>
         <td>
            <p>AXWAY.SMPE.CFT332.SMPCNTL</p>
         </td>
      </tr>
      <tr>
         <td>
            <p>USS SMP/E Network Temporary Store </p>
         </td>
         <td>
            <p>/home/AXWAY/smpnts</p>
         </td>
      </tr>
      <tr>
         <td>
            <p>USS package subdirectory </p>
         </td>
         <td>
            <p>CFT332</p>
         </td>
      ...
      <tr>
         <td>
            <p>Hostname mainframe address</p>
            <p>Login user</p>
            <p>Login password</p>
         </td>
         <td>
...
1.  Edit the sample jobs in the following table, modifying as necessary; supply a valid JOB JCL card statement, select and modify the dataset qualifier &HLQ&, and the optional device &UNIT& and volume &VOLUME&.  
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Allocate the SMP/E CSI, and the operational and work data sets used by SMP/E.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Define the SMP/E distribution and target zones.</p>
         </td>
      </tr>
   </tbody>
</table>
...
1.  Edit the sample job listed in the following table, modifying as necessary; supply a valid JOB JCL card statement, select and modify the dataset qualifier &HLQ&.  
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>UNPAX the archive package and RECEIVE the FMIDs functions. </p>
         </td>
      </tr>
   </tbody>
</table>
...
2.  Submit the job.  
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            <p>Transfer CFT exec procedures  </p>
         </td>
      </tr>
      <tr>
         <td>
      ...
      <tr>
         ...
         <td>
            <p>Transfer CFT parameter and JCL samples</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Transfer CFT general parameters</p>
         </td>
      </tr>
      <tr>
         <td>
...
1.  Edit the sample jobs that are listed in the following table, modifying as necessary; supply a valid JOB JCL card statement, select and modify the dataset qualifier &HLQ& and the optional device &UNIT& and volume &VOLUME&.  
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Allocate the Target libraries.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Perform an APPLY (with the CHECK operand) to install the SYSMOD functions in the target zone and libraries.</p>
         </td>
      </tr>
   </tbody>
</table>
...
2.  Submit the jobs in the order listed.  
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Creates the Transfer CFT instance files.</p>
         </td>
      </tr>
   </tbody>
</table>
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The Transfer CFT dataset files, the instance customization, and build steps are described in the COMMON INSTALLATION chapter.         </td>
      </tr>
</table>
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Performs a REJECT of the SYSMODs in the SMP/E global zone.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Allocates the distribution libraries.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Performs an ACCEPT (with the CHECK operand) the SYSMOD functions in the distribution zone and libraries.</p>
         </td>
      </tr>
   </tbody>
</table>
