...
You can run the setup procedure in silent mode, <span class="code">setup –s</span>. In this case, you do not have to enter parameters in the console, but prior to starting you must update the s<span class="code">ilent\_smpe\_install.conf</span> file located in the install directory.
