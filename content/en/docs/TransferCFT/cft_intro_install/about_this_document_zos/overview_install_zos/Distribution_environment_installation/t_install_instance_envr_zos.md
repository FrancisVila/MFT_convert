...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You require an installed Distribution environment before you can install the instance environment. See              <a href="..//transfercft/cft_intro_install/about_this_document_zos/overview_install_zos/distribution_environment_installation">Distribution environment installation</a>.         </td>
      </tr>
</table>
...
Next, execute the installation JCLs as described in the table [JCL installation steps](manual_installation%20steps.htm).
