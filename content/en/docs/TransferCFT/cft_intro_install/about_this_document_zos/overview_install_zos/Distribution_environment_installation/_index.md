...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><code>//DEFALIAS EXEC PGM=IDCAMS   </code>
<br/><code>//SYSPRINT DD SYSOUT=<strong>sysout</strong></code>
<br/><code>//SYSIN    DD *      </code>
<br/><code>   DEFINE ALIAS(NAME(<strong>CFTV2</strong>) RELATE(USER.CATALOG))   ...................</code>
<br/><code>/*     </code>
<br/>
         </td>
      </tr>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">ISO files were deprecated in version 3.0.1.          </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            <p>AXWAY.XFB.D332.CF030000.UPLIB	</p>
         </td>
      ...
      <tr>
         ...
         <td>A	         </td>
         <td>
            <p>Type of restoration product:</p>
            <ul>
               <li>A (ADRDSSU)               </li>
               <li>X (XMIT)               </li>
            </ul>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The distribution files are restored with 5 qualifiers (ADRDSSU). You can modify 4 of these qualifiers, for example AXWAY.XFB.CFT332.CF030000, using the ADRDSSU parameter, step ADRD020 in J1IDISTA, but the fifth qualifier is hard coded.         </td>
      </tr>
</table>
