...
## Define a Transfer CFT <span id="kanchor54"></span>alias
...
## <span id="Installa"></span><span id="kanchor55"></span>Installation files 
...
### Decompress using the <span id="kanchor56"></span>ADRDSSU format
...
### Decompress using <span id="kanchor57"></span>double Xmit
