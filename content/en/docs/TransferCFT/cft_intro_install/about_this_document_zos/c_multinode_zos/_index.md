...
Multi-node benefits for Transfer CFT{{< TransferCFT/componentshortname  >}} include:
...
The shared file system for Transfer CFT{{< TransferCFT/componentshortname  >}} z/OS is a DASD (direct-access storage device) in a SYSPLEX environment.
