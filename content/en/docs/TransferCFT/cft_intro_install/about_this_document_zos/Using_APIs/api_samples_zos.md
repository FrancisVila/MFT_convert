...
| OAPIC | CFTC  | SEND -RECV - HALT - START - DELETE  | Issue {{< TransferCFT/componentshortname  >}} commands. |
| OAPICS | CFTC  | SEND -RECV - HALT - START - DELETE  | Issue {{< TransferCFT/componentshortname  >}} commands  |
| OAPII | CFTI  | OPEN - CLOSE - (SELECT - NEXT) or (SELECT240 - NEXT240)  | List the {{< TransferCFT/componentshortname  >}} catalog. |
| OAPIIS | CFTI  | OPEN - CLOSE - (SELECT - NEXT) or (SELECT240 - NEXT240)  | List the {{< TransferCFT/componentshortname  >}} catalog.  |
| OAPISYN | cftau  | COM - SEND - GETXINFO - SWAITCAT  | {{< TransferCFT/componentshortname  >}} communication sample program using the synchronous communication media, where multiple SEND commands are possible.  |
