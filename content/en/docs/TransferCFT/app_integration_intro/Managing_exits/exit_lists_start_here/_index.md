...
the Transfer CFT{{< TransferCFT/componentshortname  >}} server's catalog. The Transfer CFT{{< TransferCFT/componentshortname  >}}
Exit list is an EXIT used for consulting the catalog.

The Exit list is not supplied with all Transfer CFT{{< TransferCFT/componentshortname  >}} products. In addition,
