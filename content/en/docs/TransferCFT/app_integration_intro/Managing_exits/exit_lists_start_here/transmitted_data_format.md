{
    ...
    "weight": "340"
}# <span id="Transmitted_data_format"></span>Critera file and data format
...
Indicates the file format of the communication area, where values are <u>1</u>, 2 C, T, J, or X (<span>1 </span>is the default).
...
Displays using the same format as in <span>Transfer CFT</span> 3.5 and lower.
...
For example: <span>S,X,X,X,MARTIN,PARIS,BIN,L1111482,2,,128,20191211,11481147,,,,,0,CP NONE</span>
