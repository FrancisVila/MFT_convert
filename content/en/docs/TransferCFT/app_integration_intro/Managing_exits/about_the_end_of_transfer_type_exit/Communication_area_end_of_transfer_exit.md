...
| usrmsg | User message, 80 characters, recorded in the {{< TransferCFT/componentshortname  >}} LOG file (CFTS18I)<br/> This message can contain the code returned by the user function and other information. |
