...
The user program can also ask the Transfer CFT{{< TransferCFT/componentshortname  >}} to modify the
...
to standard Transfer CFT{{< TransferCFT/componentshortname  >}} rules.
