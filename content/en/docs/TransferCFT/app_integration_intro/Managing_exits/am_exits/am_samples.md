...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>Flat file based on flat <a href="#">RBAC<span aria-hidden="true"><span> </span>Role Based Access Control</span></a> model         </td>
      </tr>
   </tbody>
</table>
...
To check users rights, Axway delivers a sample flat file based on flat [RBAC<span aria-hidden="true"> Role Based Access Control</span>](#) (Role Based Access Control) located in: &lt;CFTDIRRUNTME>/conf/exam.csv. This file contains a set of permission and user assignments.
