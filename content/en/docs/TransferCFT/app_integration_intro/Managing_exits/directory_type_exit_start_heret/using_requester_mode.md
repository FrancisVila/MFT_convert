{
    ...
    "weight": "420"
}# <span id="Using_requester_mode___directory_exit"></span><span>Using requester mode</span>
...
parameters that <span>Transfer CFT</span> needs to establish network and protocol connections.
...
When <span>Transfer CFT</span> does not know the partner, the following fields are
...
field of the <span>Transfer CFT</span> catalog.
...
If the msg field is defined, its content is sent to the <span>Transfer CFT</span>
