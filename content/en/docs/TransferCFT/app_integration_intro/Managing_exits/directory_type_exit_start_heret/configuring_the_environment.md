...
EXIT type directory tasks are activated in memory when Transfer CFT
...
Transfer CFT uses this attribute to exchange data with the program using
...
This module is built from the interface provided with Transfer CFT linked
