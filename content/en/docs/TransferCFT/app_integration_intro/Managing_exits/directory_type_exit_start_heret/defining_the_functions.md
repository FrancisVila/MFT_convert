...
-   Calls the initialization
    ...
    returns a 0 code, the <span>usrfct</span> function

    is called. If not, <span>Transfer CFT</span> considers that the user does not want
