...
to use the format displayed below. The <span>exitdT</span>
...
If you want to create an exit using the V2.4 format <span>exitdnT</span>
...
The structures for the C and COBOL languages are described in <span>exfus.h</span>

that is delivered with <span>Transfer CFT</span> .
...
is defined in the <span>exfus.cop</span>

file that is delivered with the <span>Transfer CFT</span> product.
