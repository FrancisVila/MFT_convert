{
    ...
    "weight": "450"
}# <span id="After_a_Synchronization_Point"></span>After a synchronization point
...
user function has to return to <span>Transfer CFT</span> the value of the synchronization
...
EXIT (DIRECT = S) or if file accessing is managed by <span>Transfer CFT</span>, the

<span>Transfer CFT</span> has all the information required to set a synchronization
