...
CFTU00I SEND \_ Correct (SWAITCAT\_OK: reached phase X, phasestep X, state X)
...
CFTU00I SEND \_ Correct (SWAITCAT\_OK: reached phase Z, phasestep H, state Z)
...
 
PRINT MSG='transfer idtu=%\_CAT\_IDTU% completed with state=%\_CAT\_STATE% and diagi=%\_CAT\_DIAGI%'
 
Output
...
config type=com,mediacom=tcpip,fname=xhttp://localhost:1765
 
send part=paris,ida=batch\_proccesing,idf=t1
char name=idtu1,init=%\_CAT\_IDTU%
send part=paris,ida=batch\_proccesing,idf=t2
char name=idtu2,init=%\_CAT\_IDTU%
send part=paris,ida=batch\_proccesing,idf=t3
char name=idtu3,init=%\_CAT\_IDTU%
send part=paris,ida=batch\_proccesing,idf=t4
char name=idtu4,init=%\_CAT\_IDTU%
