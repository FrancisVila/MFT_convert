{
    ...
    "weight": "290"
}# Synchronous transfer request examples
...
Trigger a command pending that a transfer has reached a certain defined state. See also [WSTATES](../Parameter_index/wstates.htm). This task resembles an FTP transfer.
