...
- &lt;blk> is
    a **<span style="font-weight: normal;"> {{< TransferCFT/axwayvariablesComponentShortName >}} specific field that
...
| **CLOSE code only**  | CAPI-MEM-FREE | Memory de-allocation error |
