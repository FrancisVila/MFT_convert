{
    ...
    "weight": "330"
}This topic describes the Axway{{< TransferCFT/companyname  >}} Transfer CFT{{< TransferCFT/componentshortname  >}} API templates, or samples, that are delivered with your Transfer CFT{{< TransferCFT/componentshortname  >}} product. You can use the delivered samples as a template for integrating APIs, as a model, or create your own.
