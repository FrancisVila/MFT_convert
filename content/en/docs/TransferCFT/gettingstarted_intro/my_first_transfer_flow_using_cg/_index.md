...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Tip  &lt;/b&gt;" data-valign="top">Existing <span>Transfer CFT</span> users may want to refer to the Transfer CFT to <span>Central Governance</span> parameter mapping.         </td>
      </tr>
   </tbody>
</table>
...
-   Familiarize yourself with the two user interfaces as described in the [Getting started overview](transfercft/gettingstarted_intro)
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         <td>1         </td>
         <td>            <p>Check your Transfer CFTs in <span>Central Governance</span>.<br />
</p>         </td>
         <td>            <p>In <span>Central Governance</span> select <span>Products </span>on the top toolbar to open the <span>Product List</span> page and note the host name of the <span>Transfer CFT</span>s to use in these exercises.</p>         </td>
      ...
      <tr class="odd">
         <td colspan="4"> 
            <p>Notice the association between the application <span>Name </span>and the<span> Transfer CFT</span> instance identifier. You will need the Transfer CFT identifier, for example <span>CFTlptxumcft4-01</span> in the example below, to use in your transfer commands.</p>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Tip  </strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Tip  &lt;/b&gt;" data-valign="top">The <span>Transfer CFT</span> field in <span>Central Governance</span> maps to the <span>Transfer CFT</span> PART parameter.         </td>
      </tr>
   </tbody>
</table>         </td>
      </tr>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> define a flow named Simple_flow and give it the identifier flow01.</p>
...
Note: You cannot modify the Protocol until you have defined both the Source and Target.</p>         </td>
      ...
      <tr class="even">
         ...
         <td>            <p>In <span>Transfer CFT</span>, run the following command:<br />
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Tip  </strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Tip  &lt;/b&gt;" data-valign="top">The flow Identifier field is equivalent to the <span>Transfer CFT</span> IDF parameter.         </td>
      </tr>
   </tbody>
</table>         </td>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> define a flow called <span>flow02 </span>with Store_66 as the Source, and the MainOffice as the Target.<br />
</p>         </td>
      ...
      <tr class="odd">
         ...
         <td>            <p>For this example, create a folder called Store_66 in the Store_66 <span>Transfer CFT</span> <span>runtime\pub\ </span>directory.</p>
            <p>Copy three files to this folder and call them <span>SALES_report</span>, <span>DAILY_news</span>, and <span>INVENTORY</span>.</p>         </td>
         <td>          </td>
      </tr>
      <tr class="even">
         <td>4         </td>
...
CFTUTIL SEND part=&lt;instance_MainOffice&gt;, idf=flow02, fname=#pub\Store_66\*</span>
            <p>Remember, replace <span>&lt;instance_MainOffice&gt;</span> with the Transfer CFT instance for the MainOffice as it displays in the list of applications.</p>         </td>
         <td><a href="../c_intro_userinterfaces/about_cftutil"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>6         </td>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> define a flow called <span>flow03</span>.</p>
      ...
      <tr class="even">
         ...
         <td>            <p>In the File properties of the Source, define the path to the file to be sent.</p>
            <p>In our example, use the TEST file located in the <span>Transfer CFT</span> runtime /pub folder.</p>         </td>
         <td>          </td>
      </tr>
      <tr class="odd">
         <td>3         </td>
...
CFTUTIL RECV PART=&lt;instance_Store_89&gt;, IDF=flow03</span>
            <p>Remember, replace <span>&lt;instance_Store_89&gt;</span> with the Transfer CFT instance for Store_89 as it displays in the list of applications.</p>         </td>
         <td><a href="../c_intro_userinterfaces/about_cftutil"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="odd">
         <td>5         </td>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> define a flow called <span>flow04</span>. In this flow the MainOffice is the Source with the two stores as the Targets.</p>         </td>
      ...
      <tr class="odd">
         <td>5         </td>
         <td>Run the SEND command.         </td>
         <td>            <p>In <span>Transfer CFT</span>, run the following command:</p>
            <p><span>CFTUTIL SEND PART=DEST_stores, IDF=flow04, FNAME=pub/SALES_report</span></p>         </td>
         <td><a href="../c_intro_userinterfaces/about_cftutil"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>6         </td>
...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> create a flow called <span>flow05 </span>and define the Source as MainOffice and the stores as the Target.<br />
<span>Note</span>: You cannot define the Protocol until you have defined both the Source and Target.</p>         </td>
         <td><a href="../../central_governance/cg_reference_topics/t_define_simpleFlow.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>2         </td>
         <td>Enable collect mode.         </td>
         <td>In the Collect_flow definition, modify to Target pulls file.         </td>
         <td><a href="../../central_governance/cg_reference_topics/t_defineFlow_collect.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="odd">
         <td>3         </td>
         ...
         <td><a href="../../central_governance/cg_reference_topics/t_collect_target_properties.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>4         </td>
         <td>            <p>Deploy the flow.</p>         </td>
...
Once you understand the basic modes and concepts described in this section, you can add processing, symbolic variables, scripts and more to your transfers using other Transfer CFT options and features. See the dedicated sections in this document for details on customizing your transfer flows. A good place to start is [Transfer Concepts](../../Transfers/Trans_concepts/Transfer_command_overview.htm), which presents high-level transfer processing concepts, transfer mode details, and procedural topics.
