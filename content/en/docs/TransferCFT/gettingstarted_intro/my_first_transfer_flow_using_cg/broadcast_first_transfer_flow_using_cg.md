   ...
   <tbody>
      ...
      <tr class="odd">
         ...
         <td>            <p>In <span>Central Governance</span> click <span>Deploy </span>to save and deploy the flow.</p>
            <p> </p>         </td>
         <td><a href="../../central_governance/cg_reference_topics/t_saveDeployFlow.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>            <p>4</p>
            <p> </p>         </td>
      ...
      <tr class="odd">
         ...
         <td>            <p>From the source <span>Transfer CFT</span>, run the following command:</p>
            ...
            <p> </p>         </td>
         <td><a href="../../CFTUTIL/about_CFTUTIL.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
      <tr class="even">
         <td>6         </td>
         ...
         <td><a href="../../central_governance/cg_reference_topics/c_flow_monitoring.htm"><img src="/Images/TransferCFT/mapArrow.png" /></a>         </td>
      </tr>
   </tbody>
</table>
