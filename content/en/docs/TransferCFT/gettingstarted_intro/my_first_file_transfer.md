...
The sample file features two default partners, NEWYORK and PARIS. Each of these partners is pre-configured to communicate using the [PeSIT](../../Prots/General/PeSIT_new/about_pesit.htm) protocol. Additionally, both of these partners listen on the localhost interface. You can begin with a simple transfer, and then check the catalog for transfer details.
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>Partner  DTSAPP File     Transfer         Records       Diags        Appli.   Appstate.</p>
            <p>                Id.      Id.       Transmit     Total   CFT Protocol Id.</p>
            <p>-------- ------ -------- -------- ---------- ---------- --- -------- -------- ---------</p>
            <p>NEWYORK  SFX XX TXT      J2220582        112        112   0 CP NONE</p>
            <p>PARIS    RFX XX TXT      J2220582        112        112   0 CP NONE</p>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">For more information on a command and a list of available parameters, enter <span>CFTUTIL help cmd=&lt;name of command&gt;</span>.         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*REQUESTER/SENDER*/</strong></p>
            <p>CFTPART</p>
            <p>ID = NEWYORK,</p>
            <p>PROT = PESITANY,</p>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*SERVER/RECEIVER*/</strong></p>
            <p>CFTPART</p>
            <p>ID = PARIS,</p>
            <p>PROT = PESITANY,</p>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*SERVER/SENDER*/</strong></p>
            <p>CFTPART</p>
            <p>ID = PARIS,</p>
            <p>PROT = PESITANY,</p>
            ...
            <p> </p>
            <p>LISTCAT <span>/*show transfers in hold state*/</span></p>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*REQUESTER/RECEIVER*/</strong></p>
            <p>CFTPART</p>
            <p>ID = PHOENIX,</p>
            <p>PROT = PESITANY,</p>
   ...
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*SERVER/SENDER*/</strong></p>
            ...
            <p> </p>
            <p>LISTCAT <span>/*would show transfer in hold state*/</span></p>         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*RECEIVER/SERVER*/</strong></p>
            <p> </p>
            <p>CFTPART</p>
            <p>ID = PARIS,</p>
            <p>PROT = PESITANY,</p>
...
[More information](../../Transfers/Trans_concepts/Broadcast_collect.htm)...
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*RECEIVER 1*/</strong></p>
            <p>CFTPART</p>
            <p>ID = PARIS,</p>
            <p>PROT = PESITANY,</p>
            <p>SAP = 1761, <span>/* remote listening port for Paris */</span></p>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p><strong>/*RECEIVER 2*/</strong></p>
            <p>CFTPART</p>
            <p>ID = PARIS,</p>
            <p>PROT = PESITANY,</p>
            <p>SAP = 1761, <span>/* remote listening port for Paris */</span></p>
...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td data-valign="top">         </td>
         <td data-valign="top"><span><strong>Note</strong></span>         </td>
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">In these examples we created partners using the default MODE value, which is REPLACE. You can also use the MODE=CREATE, to create a new <span>Transfer CFT</span> partner.         </td>
      </tr>
   </tbody>
</table>
