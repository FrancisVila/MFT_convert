...
[CFTSEND/SEND](../../GUI/Concepts/Default_SEND_template_concepts.htm)
or [CFTRECV/RECV](../../GUI/Concepts/Default_receive_template_concepts.htm)
commands.
...
variables](../../CFTUTIL/Parameter_index/symbolic_variables.htm) to define these parameters.
...
-   Which is interrupted,
    ...
    Diagnostics and Messages](../../Troubleshooting/Messages_and_Codes/Messages_and_error_codes_Start_here.htm)*) or K
    state
-   Which is refused
...
The *[Symbolic
variables](../../CFTUTIL/Parameter_index/symbolic_variables.htm)* paragraph indicates the symbolic variables which can
