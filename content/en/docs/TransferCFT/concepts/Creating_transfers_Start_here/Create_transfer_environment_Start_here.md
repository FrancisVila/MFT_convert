...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The <i>default</i> CFTSEND object for its part applies to all the other 
...
-   Action to be
    ...
    compression
-   Action performed
    by the Transfer CFT on the file sent, after the transfer
-   Call to a procedure
...
## <span id="Transfer_environment_parameters"></span>Transfer environment parameters
