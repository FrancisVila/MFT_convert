...
### <span id="Read_transfer_implicit_send_open_mode"></span>Read transfer implicit send open mode
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If a requester defines FNAME=&amp;NFNAME and the server has not defined 
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If a requester defines NFNAME and the server has not defined FNAME 
