...
### <span id="Model_files__IDF"></span>Model files: IDF
...
An identifier corresponds to each flow definition. In the absence of this flow identifier, Transfer CFT uses the flow default value.
...
by the Transfer CFT as a specific transfer. A message transfer does not make reference to a flow definitiona CFTSEND or CFTRECV command.
