...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">This document describes the relay process as it relates to Transfer CFT. You can perform relay transfers using other Axway  products as the intermediary site.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top"> If you are using access management, you must define the CFTAPPL with the ID=COMMUT.         </td>
      </tr>
</table>
...
If you are using Transfer CFT without additional governance, you can manage store and forward as described below.
...
<table cellspacing="0">
 ...
 and forward.         </td>
      ...
      <tr>
         ...
         <td>
               <li>Sending the file occurs at the initiative 
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>CFTPART ID=IDRECEPT, COMMUT=PART, IPART=IDEMET,...</p>
            <p>CFTPART ID=IDEMET,...</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">entries and that these entries are linked. In the example above, there would be two entries for the single "report" transfer.         </td>
      </tr>
</table>
