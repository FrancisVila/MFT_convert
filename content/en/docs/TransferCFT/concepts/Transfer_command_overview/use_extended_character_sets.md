...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">On versions of OS/400 prior to Transfer CFT 3.1.3, use the charset number only without the CFT_ prefix.         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>CFTUTIL RECV PART = NEWYORK,</p>
            <p>  IDF = TEST_IGNORE,</p>
