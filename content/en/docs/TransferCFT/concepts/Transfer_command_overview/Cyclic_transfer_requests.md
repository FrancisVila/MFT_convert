{
    ...
    "weight": "280"
}# <span id="Cyclic_transfer_requests"></span>Cyclic transfer requests
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The CYCDATE/CYCTIME is equivalent to the MAXDATE/MAXTIME for a request. If the request is not executed before the date/time, then the request is not executed (times out).         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr valign="middle">
         <td valign="top" width="24.312%">
            <p>MIN CYC </p>
         </td>
         <td valign="top" width="75.688%">
            <p>Cycle expressed in minutes </p>
         </td>
      </tr>
      <tr valign="middle">
         <td valign="top" width="24.312%">
