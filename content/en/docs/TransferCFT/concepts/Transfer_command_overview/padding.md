...
<table>
   <tbody>
      <tr>
         ...
         <td>In addition to printable characters, you can also enter a non-printable character for NPAD or FPAD using the hexadecimal syntax: 0xHH. For example: <span class="code">0xFC, 0xab, 0x00</span>         </td>
      </tr>
   </tbody>
</table>
