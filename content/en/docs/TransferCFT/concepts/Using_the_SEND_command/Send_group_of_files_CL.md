...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If FNAME designates a generic name and the &lt;file_symb&gt; 
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You cannot use a file name with an asterisk, for example fil*, as that denotes the beginning of a file not a directory.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">See also <a href="../../phase_and_phasestep/processing_compatability">COMPAT</a> mode, if using backward compatibility.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You can specify a list of directories to be sent in the indirection 
 file. 
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>SEND FNAME=#<i>mask</i> or SEND FNAME=#<i>dirname</i>         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
        ...
        <br/>fname   = #c:\e\cft320\tmp\a*, 

        <br/>wfname  = c:\e\cft320\&amp;idtu.snd, 

        <br/>frecfm  = v, 

        ftype   = b, <br/>mode    = create 

<br/>cftrecv id      = copie, <br/>fname   = c:\cft320\bin\recv, 

        <br/>faction = delete, 

        <br/>wfname  = &amp;idtu.rcv, <br/>ftype   = b </p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>No         </td>
         <td>
            <p>Force heterogeneous mode for group file transfers. This parameter replaces the deprecated environment variable: CFTSFMCPY. </p>
            <p>Possible values:</p>
            <ul>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The following is valid when using the same system type <i>and</i> heterogeneous mode is not forced. When using <span>Central Governance</span> remember that heterogeneous mode is the default setting.         </td>
      </tr>
</table>
