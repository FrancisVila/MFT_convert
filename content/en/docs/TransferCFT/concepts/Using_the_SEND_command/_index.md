...
See [SELFNAME](../../CFTUTIL/Parameter_index/selfname.htm).
...
scheduling](../Trans_concepts/Delayed_transfers.htm).
...
transfer requests](../Trans_concepts/Cyclic_transfer_requests.htm).
...
See also [WFNAME](../../CFTUTIL/Parameter_index/wfname.htm).
...
For details transfer activities and scheduling, see [Processing execution policy](../processing/processing_exec_policy.htm).
...
See [Transfer
error procedures](../Trans_concepts/transfer_related_procedures.htm) for more information.
...
See also [Store and forward](../Trans_concepts/Store_and_forward_mode_routing.htm).
...
After configuring the [synchronous communication](../../appl_integration/synch_comm_tcpip_intro.htm), add the wstate and wtimeout to the send command.
