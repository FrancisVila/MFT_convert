...
-   To control
    ...
    from one transfer to another and which Transfer CFT cannot locate automatically,
...
## <span id="About_default_SEND_parameters"></span>About default SEND parameters
...
Correspondence
between the SEND command (file) and Transfer CFT parameter setting
