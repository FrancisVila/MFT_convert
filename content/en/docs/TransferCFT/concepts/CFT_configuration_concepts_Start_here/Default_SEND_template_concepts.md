...
-   To control
    ...
    from one transfer to another and which <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span> cannot locate automatically,
...
-   The file network
    ...
    The physical characteristics that <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span> is able to locate automatically
...
Correspondence
between the SEND command (file) and <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span> parameter setting
