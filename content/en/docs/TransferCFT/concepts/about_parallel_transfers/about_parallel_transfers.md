{
    "title": "Configuring simultaneous transfers",
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Some parameters benefit from further tuning if using a multi node architecture. See also Multi-node partner configuration.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>CFTNET id=NET0, maxcnx=10            <p>CFTNET id=NET1, maxcnx=20</p>         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">We recommend using the default value for cft.server.max_session.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">We recommend setting these values to 60 seconds or less.         </td>
      </tr>
</table>
...
### <span id="License"></span>License key
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">There is a one to one relationship between a transfer and its task. That is, the task cannot be shared, so it is recommended to set the MAXTASK to less than or equal to MAXTRANS.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>MAXTRANS = 14,            <p>MAXTASK = 2,<br/>TRANTASK = 4,</p>         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The WSCAN scheduling retries continues indefinitely until the transfer can be executed.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>CNXOUT=(Partner's CNXIN) 	</p>
         </td>
         <td>CNXIN = (Partner’s CNXOUT)         </td>
      </tr>
      <tr>
         <td>
            <p>CNXIN=(Partner’s CNXOUT)	</p>
         </td>
         <td>CNXOUT=(Partner’s CNXIN)         </td>
      </tr>
      <tr>
         <td>
            <p>CNXINOUT=CNXIN+CNXOUT	</p>
         </td>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The RETRYW scheduling retries is limited by the RETRYM number.         </td>
      </tr>
</table>
