...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY03E"></span>CFTY03E PID=&amp;pid System error [&amp;string] CR=&amp;cr
CS=&amp;cs</p>
...
CS=&amp;cs</p>         </td>
      ...
      <tr>
         ...
         <td><p>A new SSL task cannot initialize its working environment. According
to the error origin, various messages are given below.</p>         </td>
      </tr>
      <tr>
         <td><p>Result</p>         </td>
         <td><p>The SSL session in progress is aborted.</p>         </td>
      </tr>
      <tr>
         <td><p>V23 format</p>
<p>V24 format</p>
...
PID=&amp;pid System error [MMALLOC] CR=&amp;cr CS=&amp;cs</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Dynamic memory allocation failure.</p>         </td>
      </tr>
      <tr>
         <td><p>V23 format</p>
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY03E PID=&amp;pid System error [SYDEF] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY03E PID=&amp;pid System error [SYDEF] CR=&amp;cr CS=&amp;cs</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Task semaphore creation failure:</p>
<ul>
<li>CR=-1 Maximum
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY03E PID=&amp;pid System error [SYPOST] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY03E PID=&amp;pid System error [SYPOST] CR=&amp;cr CS=&amp;cs</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Semaphore write failure:</p>
<ul>
<li>CR=-1 Undefined
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY03E PID=&amp;pid System error [SYWAIT] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY03E PID=&amp;pid System error [SYWAIT] CR=&amp;cr CS=&amp;cs</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Semaphore read failure:</p>
<ul>
<li>CR=-1 Undefined
semaphore</li>
<li>CR=-3 Already
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY03E PID=&amp;pid System error [CTXDEF] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY03E PID=&amp;pid System error [CTXDEF] CR=&amp;cr CS=&amp;cs</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>SSL session context manager creation failure:</p>
<ul>
<li>CR=-2,-3 Dynamic
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY03E PID=&amp;pid System error [STARTPKI] CR=&amp;cr CS=&amp;cs</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY04E"></span>CFTY04E PID=&amp;pid PKIFNAME=&amp;string Internal PKI
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY04E PID=&amp;pid PKIFNAME=&amp;string Internal PKI error
...
[FMALLOC] CR=&amp;cr CS=&amp;cs</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>File allocation failure:</p>
<ul>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY05E"></span>CFTY05E PID=&amp;pid PKIFNAME=&amp;file Syntax error
_ &amp;string</p>
...
_ &amp;string</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>The index file of the local certificate data base is not valid.
...
number in the file is displayed</li>
      ...
      <tr>
         <td><p>Result</p>         </td>
         <td><p>The SSL session in progress
is aborted.</p>         </td>
      </tr>
      <tr>
         <td><p>Action </p>         </td>
         <td><p>Rectify the index file.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY06E"></span>CFTY06E CTX=&amp;ctx Certificate Request Message error
_ &amp;string</p>
...
_ &amp;string</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>SSL handshake error: a request certificate message, sent by
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY07E"></span>CFTY07E CTX=&amp;ctx System error [&amp;string] CR=&amp;cr
CS=&amp;cs</p>
...
CS=&amp;cs</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>SSL handshake error. According to the error origin, various
messages are given below.</p>         </td>
      </tr>
      <tr>
         <td><p>Result</p>         </td>
         <td><p>The SSL session in progress is aborted. An alert is sent
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY07E CTX=&amp;ctx System error [MMALLOC] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY07E CTX=&amp;ctx System error [MMALLOC] CR=&amp;cr CS=&amp;cs</p>         </td>
      ...
      <tr>
         <td><p>Result</p>         </td>
         <td><p>If the SSL handshake is in progress, the session is aborted
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY07E CTX=&amp;ctx System error [SYPOST] CR=&amp;cr CS=&amp;cs</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY07E CTX=&amp;ctx System error [CTXALLOC] CR=&amp;cr CS=&amp;cs</p>
<p>CFTY07E CTX=&amp;ctx System error [CTXALLOC] CR=&amp;cr CS=&amp;cs</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Memory allocation error for a new SSL session context:</p>
<ul>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY07E CTX=&amp;ctx System error [CTXCHK] CR=&amp;cr CS=&amp;cs</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p>CFTY07E PROT=&amp;prot SSLPID=&amp;pid HOST=&amp;host synchronization
...
the SSL initialization phase</p>         </td>
      ...
      <tr>
         <td><p>Action</p>         </td>
         <td><p>Analyze the &amp;scs code and contact the product support team
if necessary</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY08I"></span>CFTY08I PID=&amp;pid Task started successfully</p>
<p>CFTY08I PID=&amp;pid Task started successfully</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Successful creation of a new SSL task.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY09I"></span>CFTY09I PID=&amp;pid Task ended</p>
<p>CFTY09I PID=&amp;pid Task ended</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>SSL task ended.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY10E"></span>CFTY10E PID=&amp;pid CTX=&amp;ctx Invalid reference on
&amp;string</p>
...
&amp;string</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Invalid network message received (context is invalid or already
free).</p>         </td>
      </tr>
      <tr>
         <td><p>Result</p>         </td>
         <td><p>Message is not treated.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY11I"></span>CFTY11I CTX=&amp;ctx PART=&amp;id SSL=&amp;id Closing
...
client SSL session</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>A client SSL session is closed. The session reference and the
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY12I"></span>CFTY12I CTX=&amp;ctx PROT=&amp;id SSL=&amp;id Closing
...
server SSL session</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>A server SSL session is closed. The session reference and the
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY13E"></span>CFTY13E CTX=&amp;ctx SSL Handshake local error [&amp;string]
CR=&amp;cr</p>
...
CR=&amp;cr</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>SSL session handshake failure.</p>         </td>
      </tr>
      <tr>
         <td><p>Result</p>         </td>
         <td><p>The SSL session in progress is aborted. An alert is sent
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY14I"></span>CFTY14I CTX=&amp;ctx PART=&amp;id SSL=&amp;id client
...
<p> </p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Successful handshake. A new client SSL session is established.
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY15I"></span>CFTY15I CTX=&amp;ctx PROT=&amp;id SSL=&amp;id server
...
session established VERSION=&amp;ver CIPHER=&amp;num AUTH=&amp;mode</p>         </td>
      ...
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Successful handshake. A new server SSL session is established.
The negotiated version, cypher suite, and the authentication mode (SERVER or BOTH)
are displayed.</p>         </td>
      </tr>
   </tbody>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY16I"></span>CFTY16I CTX=&amp;ctx &amp;message</p>
<p>CFTY16I CTX=&amp;ctx &amp;message</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Message sent by the external PKI exit.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY17I"></span>CFTY17I CTX=&amp;ctx &amp;msg</p>
<p>CFTY17I CTX=&amp;ctx &amp;msg</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Specific exit security (PKI System) message.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY18E"></span>CFTY18E CTX=&amp;ctx &amp;str</p>
<p>CFTY18E CTX=&amp;ctx &amp;str</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Internal error on calling up the internal PKI. The "&amp;str"
...
and so on)</li>
      ...
      <tr>
         <td><p>Action</p>         </td>
         <td><p>Contact the product support team if necessary.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY19I"></span>CFTY19I PART=&amp;id SSL=&amp;id opening client session
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY20I"></span> CFTY20I PROT=&amp;id SSL=&amp;id opening server session
CTX=&amp;ctx on task PID=&amp;pid</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY21I"></span>CFTY21I CTX=&amp;ctx Remote server certificate accepted</p>
<p>CFTY21I CTX=&amp;ctx Remote server certificate accepted</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>A server certificate is accepted during a session handshake.
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY22I"></span>CFTY22I CTX=&amp;ctx Remote client certificate accepted</p>
<p>CFTY22I CTX=&amp;ctx Remote client certificate accepted</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>A client certificate is accepted during a session handshake.
The authority identifier which has signed the certificate is displayed.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY23I"></span>CFTY23I CTX=&amp;ctx Client certificate ID=&amp;id ROOTID=&amp;id</p>
<p>CFTY23I CTX=&amp;ctx Client certificate ID=&amp;id ROOTID=&amp;id</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Client certificate used locally for authentication.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY24I"></span>CFTY24I CTX=&amp;ctx Server certificate ID=&amp;id ROOTID=&amp;id</p>
<p>CFTY24I CTX=&amp;ctx Server certificate ID=&amp;id ROOTID=&amp;id</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>Server certificate used locally for authentication.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY25I"></span>CFTY25I CTX=&amp;ctx remote address HOST=&amp;string</p>
<p>CFTY25I CTX=&amp;ctx remote address HOST=&amp;string</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>This message is displayed after the message CFTY20I. It gives
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY26I"></span>CFTY26I CTX=&amp;ctx Anonymous &amp;str session</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY28W"></span>CFTY28W CTX=&amp;ctx &amp;str2 = &amp;filename</p>
<p>CFTY28W CTX=&amp;ctx &amp;str2 = &amp;filename</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>The file contains the remote certificate has not been recorded.</p>         </td>
      </tr>
      <tr>
         <td><p>Consequence</p>         </td>
         <td><p>The transfer can be performed but the remote certificate is
not recorded.</p>         </td>
      </tr>
      <tr>
         <td><p>Action</p>         </td>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY30E"></span>CFTY30E CTX=&amp;ctx SSL Handshake remote error [&amp;string] CR=&amp;cr</p>
<p>CFTY30E CTX=&amp;ctx SSL Handshake remote error [&amp;string] CR=&amp;cr</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td>SSL session handshake failure. An alert has been received from the remote peer.         </td>
      </tr>
      <tr>
         <td><p>Consequence</p>         </td>
         <td>The SSL session in progress is aborted.         </td>
      </tr>
      <tr>
         <td><p>Action</p>         </td>
         <td>Analyze the &amp;cr error code (refer to the SSL protocol error codes). Also check the remote partner log for more details. Contact Axway support if necessary.         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY41E"></span>CFTY41E CFTCTX=&lt;session_reference&gt;, xpp call &lt;PassportPS_API_function&gt;: error [&lt;PassportPS_API_function_returncode&gt;]</p>
<p>CFTY41E CFTCTX=&lt;session_reference&gt;, xpp call &lt;PassportPS_API_function&gt;: error [&lt;PassportPS_API_function_returncode&gt;]</p>         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>An error occurred during an exchange or connection with the PassPort PS server.</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><span id="CFTY44E"></span>CFTY44E CFTCTX=&lt;session_reference&gt;, long err msg : [&lt;PassportPS_API_error_code&gt;]         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>An error occurred during an exchange or connection with the PassPort PS server. The &lt;PassportPS_API_error_code&gt; describes the error.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><span id="CFTY45E"></span>CFTY45E CFTCTX=&lt;session_reference&gt;, &lt;PassportPS_API_error_message&gt;         </td>
      </tr>
      <tr>
         <td><p>Explanation</p>         </td>
         <td><p>An error occurred during an exchange or connection with the PassPort PS server. The &lt;PassportPS_API_error_message&gt; describes the error.</p>         </td>
      </tr>
   </tbody>
</table>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY50I"></span>CFTY50I SSH client session established CTX=&amp;ctx PART=&amp;part Version=&amp;version Cipher in=&amp;cipher Cipher out=&amp;cipher Key exchange=&amp;key hmac in=&amp;hmac hmac out=&amp;hmac &amp;IPVersion</p>
<p>CFTY50I SSH client session established CTX=&amp;ctx PART=&amp;part Version=&amp;version Cipher in=&amp;cipher Cipher out=&amp;cipher Key exchange=&amp;key hmac in=&amp;hmac hmac out=&amp;hmac</p>         </td>
      ...
      <tr>
         <td>Explanation         </td>
         <td>Established a new SSH client session.
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY51I"></span>CFTY51I SSH server session established CTX=&amp;ctx PART=&amp;part Version=&amp;version Cipher in=&amp;cipher Cipher out=&amp;cipher Key exchange=&amp;key hmac in=&amp;hmac hmac out=&amp;hmac &amp;IPVersion</p>
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY52I"></span>CFTY52I SFTP client session established CTX=&amp;ctx PART=&amp;part Version=&amp;version Authentication=&amp;authentication CFT Server=&amp;server</p>
<p>CFTY52I SFTP client session established CTX=&amp;ctx PART=&amp;part Version=&amp;version Authentication=&amp;authentication CFT Server=&amp;server</p>         </td>
      ...
      <tr>
         <td>Explanation         </td>
         <td>Established a new SFTP client session.
...
<p>V24 format</p>
<p>Information</p>         </td>
         <td><p><span id="CFTY53I"></span>CFTY53I SFTP server session established CTX=&amp;ctx PROT=&amp;prot Version=&amp;version Authentication=&amp;authentication CFT Client=&amp;client</p>
<p>CFTY53I SFTP server session established CTX=&amp;ctx PROT=&amp;prot Version=&amp;version Authentication=&amp;authentication CFT Client=&amp;client</p>         </td>
      ...
      <tr>
         <td>Explanation         </td>
         <td><p>Established a new SFTP server session.
