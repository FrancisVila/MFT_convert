...
Transfer CFT{{< TransferCFT/componentshortname  >}} diagnostic codes corresponding to the reception of an FPDU
...
- HHHH
    is a hexadecimal value corresponding to the Transfer CFT{{< TransferCFT/componentshortname >}} numeric code
    ODETTE protocol

See alsoTransfer CFT{{< TransferCFT/componentshortname  >}} Numeric Codes ODETTE Protocol.

<span id="XXX_HHHH_Type_ODETTE_DIAGP_Codes"></span>

## "XXX HHHH"-Type ODETTE DIAGP Codes

Transfer CFT{{< TransferCFT/componentshortname  >}} diagnostic code identifying an FPDU negotiation or send
...
- HHHH
    is a Transfer CFT{{< TransferCFT/componentshortname >}} numeric code - ODETTE protocol. This is a hexadecimal
    value corresponding to the internal protocol code.

See also
"[Transfer CFT{{< TransferCFT/componentshortname  >}} ODETTE](../../../protocols_start_here/start_here_odette)"
