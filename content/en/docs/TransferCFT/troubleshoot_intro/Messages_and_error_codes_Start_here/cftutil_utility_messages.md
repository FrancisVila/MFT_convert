...
_ unknown command</p>         </td>
      ...
      <tr class="even">
         <td>            <p>Action</p>         </td>
         <td>            <p>Check the <a href="../../c_intro_userinterfaces/command_summary">command syntax</a> in the <span>Transfer CFT</span> Online documentation.
...
or format, compression code or state).</p>
            <p><a href="../../admin_intro/admin_commands_intro/copyfile_command">COPYFILE
