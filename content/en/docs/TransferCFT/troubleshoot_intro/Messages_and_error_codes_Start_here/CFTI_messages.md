...
| --- | --- |
| Explanation | Displays information about the {{< TransferCFT/componentshortname  >}} Heartbeat. Possible states:<br/> • Enable<br/> • Update UCONF parameters<br/> • Disable |
