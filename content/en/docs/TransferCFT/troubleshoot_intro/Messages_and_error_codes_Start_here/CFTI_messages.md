...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>Internal <span>Transfer CFT</span> execution error.</p>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when allocating the <span>Transfer CFT</span> parameter file.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
then restart <span>Transfer CFT</span>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when opening the <span>Transfer CFT</span> parameter file.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Action</p></td>
<td><p>Correct
the error and then restart <span>Transfer CFT</span>.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when allocating the <span>Transfer CFT</span> partner file.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when opening the <span>Transfer CFT</span> partner file.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when allocating the <span>Transfer CFT</span> catalog file.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when activating the <span>Transfer CFT</span> protocol process.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Explanation</p></td>
<td><p>During <span>Transfer CFT</span> initialization an error was detected
when activating the <span>Transfer CFT</span> communication process.</p></td>
</tr>
<tr class="odd">
<td><p>Consequence</p></td>
<td><p>The Transfer
...
<td><p>Explanation</p></td>
<td><p>Normal end
of <span>Transfer CFT</span> logging process initialization.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Explanation</p></td>
<td><p>Normal end
of <span>Transfer CFT</span> protocol process initialization.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>Normal end of <span>Transfer CFT</span> communication task initialization.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Explanation</p></td>
<td><p>Normal end
of <span>Transfer CFT</span> initialization.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>During the <span>Transfer CFT</span> initialization phase an error was
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>This is a <span>Transfer CFT</span> welcome message describing the computer environment
...
or protocol option, <span>Transfer CFT</span> does not start, and displays a message.<br />
...
<tr class="odd">
<td><p>Consequence</p></td>
<td><p><span>Transfer CFT</span> is stopped during the initialization phase.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p><span>Transfer CFT</span> copyright message.</p></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><p>Consequence</p></td>
<td><p><span>Transfer CFT</span> is stopped during its initialization phase.</p></td>
</tr>
</tbody>
</table>
...
<ul>
<li>HAB: Normal end of initialization with activation of the <span>Transfer CFT</span> security system</li>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>When <span>Transfer CFT</span> was initialized, a security system open
...
<p>Error
 </p></td>
<td width="80%"><p><span id="CFTI38E"></span>CFTI38E CRONJOB: ID=&amp;idcron, CRONTAB=&amp;cronname INSERT FAILED</p>
<p>CFTI38E CRONJOB: ID=&amp;idcron, CRONTAB=&amp;cronname INSERT FAILED</p></td>
</tr>
<tr class="even" data-valign="top">
<td><p>Explanation</p></td>
<td width="80%"><p> Insert failed due to incorrect entry or unexpected character. Check CRONTAB parameters, such as TIME.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><p>Explanation</p></td>
<td><p>Displays information about the <span>Transfer CFT</span> Heartbeat. Possible states:</p>
<ul>
<li>Enable</li>
...
<ol>
<li>For an existing installation, use the command <span>cftutil about</span> to retrieve your system information. The <strong>ABOUT</strong> command displays
...
<ul>
<li>For a US key, contact: <span>fulfillment@us.axway.com</span></li>
<li>For an EMEA or APAC key, contact: <span>product.key@axway.com</span></li>
</ul></li>
...
<td data-mc-autonum="&lt;b&gt;Note  &lt;/b&gt;" data-valign="top">When working in multi-node you must have one key per node and host.</td>
</tr>
</tbody>
</table>
