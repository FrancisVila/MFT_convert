...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB01E"></span>CFTB01E PART=&amp;part Context area allocation failure
CS=&amp;scs</p>
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB02E"></span>CFTB02E PART=&amp;part
...
<tr class="odd" data-valign="top">
<td width="20%"><p>Consequence</p></td>
<td width="80%"><p>In REQUESTER mode, the transfer is refused with a Transfer
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB03E"></span>CFTB03E PART=&amp;part Error sending data on network
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB06E"></span>CFTB06E Flow control error NCR=&amp;ncr NCS=&amp;ncs
NET=&amp;net</p>
<p>CFTB06E PART=&amp;part Flow control error NCR=&amp;ncr NCS=&amp;cs NET=&amp;net</p></td>
</tr>
<tr class="even" data-valign="top">
<td width="20%"><p>Explanation</p></td>
<td width="80%"><p>Network flow control error.</p></td>
</tr>
</tbody>
</table>
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB07E"></span>CFTB07E PART=&amp;part TFIL task Synchronization error
CR=&amp;cr CS=&amp;cs</p>
<p>CFTB07E PART=&amp;part TFIL task Synchronization error CR= &amp;cr CS=&amp;cs</p></td>
</tr>
<tr class="even" data-valign="top">
<td width="20%"><p>Explanation</p></td>
<td width="80%"><p>Problem encountered when sending an internal <span>Transfer CFT</span>
message to the FILE task.</p></td>
</tr>
<tr class="odd" data-valign="top">
<td width="20%"><p>Consequence</p></td>
<td width="80%"><p>The transfer is aborted by the protocol task (network disconnection).
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB08E"></span>CFTB08E PART=&amp;part Network release resp err NCR=&amp;ncr
NCS=&amp;ncs NET=&amp;net</p>
<p>CFTB08E PART=&amp;part Network release resp err NCR=&amp;ncr NCS=&amp;cs NET=&amp;net</p></td>
</tr>
<tr class="even" data-valign="top">
<td width="20%"><p>Explanation</p></td>
<td width="80%"><p>Cannot respond to a network disconnection indication.</p></td>
</tr>
<tr class="odd" data-valign="top">
<td width="20%"><p>Consequence</p></td>
<td width="80%"><p>This incident has no effect on the previous transfer (whether
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB09E"></span>CFTB09E PART=&amp;part Network connect req local err
NCR=&amp;ncr NCS=&amp;ncs NET=&amp;net</p>
<p>CFTB09E PART=&amp;part Network connect req local err NCR=&amp;ncr NCS=&amp;cs NET=&amp;net</p></td>
</tr>
<tr class="even" data-valign="top">
<td width="20%"><p>Explanation</p></td>
<td width="80%"><p>Cannot make an outgoing connection request on the network.</p></td>
</tr>
<tr class="odd" data-valign="top">
<td width="20%"><p>Consequence</p></td>
<td width="80%"><p>For a general
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB10E"></span>CFTB10E PART=&amp;part RECOV=&amp;recov L=&amp;local
R=&amp;reason D=&amp;diag NET=&amp;net</p>
<p>CFTB10E PART=&amp;part RECOV=&amp;recov L=&amp;local R=&amp;reason ld D=&amp;diag ld NET=&amp;net</p></td>
</tr>
<tr class="even" data-valign="top">
<td width="20%"><p>Explanation</p></td>
<td width="80%"><p>Physical connection refused.</p></td>
</tr>
<tr class="odd" data-valign="top">
<td width="20%"><p>Consequence</p></td>
<td width="80%"><p>Depending on the source of the refusal and the RECOV code, the
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB18E"></span>CFTB18E Incoming call reject error NCR=&amp;ncr NCS=&amp;ncs
NET=&amp;net</p>
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB19E"></span>CFTB19E Incoming call accept error NCR=&amp;ncr NCS=&amp;ncs
NET=&amp;net</p>
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB19E"></span>CFTB20E Invalid ETEBAC3 Card &amp;id NET=&amp;net</p>
...
<p>V24 format</p>
<p>Error</p></td>
<td width="80%"><p><span id="CFTB21E"></span>CFTB21E PART=&amp;part MAIN task Synchronization error
CR=&amp;cr CS=&amp;scs</p>
