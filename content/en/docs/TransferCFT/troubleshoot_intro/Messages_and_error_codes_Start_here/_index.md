...
<th><p>CFTxxx: the actual message that is displayed on <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span></p>         </th>
   ...
   <tbody>
      <tr>
         ...
         <td><p>The elements, such as variables, in the above message are detailed.</p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td>Action         </td>
         <td>If applicable, add corrective action here.         </td>
      </tr>
   </tbody>
</table>
...
Actions relating to transfers         </td>
      ...
      <tr>
         <td>U         </td>
         <td>CFTUTIL: Messages from the CFTUTIL utility         </td>
      </tr>
      <tr>
         <td>X         </td>
         <td>Security:
