...
HOST value (CFTNET object).yes (the default value)               </li>
            ...
            <ul>
               <li>            <p>Try a Transfer CFT packet analyzer such as <a href="https://www.wireshark.org/">Wireshark</a></p>               </li>
            </ul>         </td>
      </tr>
      <tr class="even">
...
-   PassPort PKI
    ...
    For more information on other common SSL errors, see [Troubleshoot security errors](troubleshoot_security).
