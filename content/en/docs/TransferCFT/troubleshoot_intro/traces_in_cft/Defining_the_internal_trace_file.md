   ...
   <tbody>
      <tr>
         <td valign="top" width="46%">
            <p>Update the general parameters before Transfer CFT start-up </p>
         </td>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>CFTTRACE <br/>[XTRACE = {<u>0</u> | 0..7},]<br/><br/>ID = <i>identifier</i>,<br/>[TRCFNAM = <u>" "</u> | <i>filename</i>,]<br/>[TRCFTYP = {<u>STANDARD</u> | CIRCULAR},]<br/>[TRCLREC = n,]<br/>[TRCNREC = n,]<br/>[MODE = {<u>CREATE</u> | REPLACE | DELETE},]<br/>START = {<u>CFT</u> | DELAYED}         </td>
      </tr>
   </tbody>
</table>
