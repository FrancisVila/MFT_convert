...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td valign="top">
            <p>Define the trace file or files:</p>
            <ul>
               <li>Before 
 ...
 Transfer CFT operations                </li>
      ...
      <tr>
         <td valign="top">
            <p>Start information collection:</p>
            <ul>
               <li>Transfer 
 CFT start               </li>
               <li>During 
 Transfer CFT operations                </li>
      ...
      <tr>
         <td valign="top">
            <p>Stop information collection </p>
         </td>
         <td valign="top" width="24%">
            <p>STOPTRC </p>
         </td>
      ...
      <tr>
         <td valign="top">
            <p>Close files and shut down the process </p>
         </td>
         <td valign="top" width="24%">
            <p>SETTRC </p>
         </td>
   ...
   <tbody>
      <tr valign="middle">
         <td valign="top" width="23%">
            <p>Before starting<br/>Transfer CFT </p>
         </td>
         <td valign="top" width="16%">
            <p>CFTPARM </p>
         </td>
         <td valign="top" width="21%">
            <p>TRACE=identifier </p>
         </td>
         <td valign="top" width="39%">
            <p>CFTTRACE command identifier </p>
         </td>
      </tr>
      <tr valign="middle">
         <td valign="top" width="23%">
      ...
      <tr valign="middle">
         ...
         <td valign="top" width="39%">
            <p>The defined file is a trace file </p>
         </td>
      </tr>
      <tr valign="middle">
         <td valign="top" width="23%">
            <p>During Transfer CFT operations </p>
         </td>
         <td valign="top" width="16%">
            <p>SETTRC </p>
         </td>
         <td valign="top" width="21%">
            <p>MODE=CREATE or MODIFY </p>
         </td>
         <td valign="top" width="39%">
            <p> </p>
         </td>
   ...
   <tbody>
      <tr>
         <td valign="top" width="28%">
            <p>When starting up Transfer CFT </p>
         </td>
      ...
      <tr>
         <td valign="top" width="28%">
            <p>During Transfer CFT<br/>operations </p>
         </td>
         <td valign="top" width="22%">
            <p>CFTTRACE </p>
         </td>
...
<table cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         <td valign="top" width="29%">
            <p>Stop collection, close the files and shutdown the process </p>
         </td>
         <td valign="top" width="34%">
            <p>CFTTRACE </p>
         </td>
         <td valign="top" width="38%">
            <p>STOPTRC<br/>and<br/>SETTRC MODE=DELETE</p>
         </td>
      </tr>
      <tr>
         <td valign="top" width="29%">
...
## <span id="Using_the_stop_trace_command"></span>Using the STOPTRC command<span id="About_the_STOPTRC_command"></span>
...
## <span id="About_the_TRCFILE_command"></span>TRCFILE command details
