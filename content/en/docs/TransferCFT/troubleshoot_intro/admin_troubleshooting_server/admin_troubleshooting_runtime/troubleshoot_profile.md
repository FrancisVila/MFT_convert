{
    ...
    "weight": "440"
}If error messages display when loading the profile, for example "CFTDIRDAT parameter not set", the error may be due to a new file in the $CFTDIRRUNTIME/profile.d directory. An example of this is cft-autocomplete.bash\_completion, which was introduced in Transfer CFT{{< TransferCFT/transfercftname  >}} 3.3.0.
