...
1. Requests from {{< TransferCFT/transfercftname >}} to {{< TransferCFT/centralgovernancename >}} (registration /heartbeat):  
...
1. Ensure the **Transfer CFT Connector** service in {{< TransferCFT/centralgovernancename >}} is in debug mode:  
