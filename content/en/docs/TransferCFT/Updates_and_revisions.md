...
-   \[SECURITY\] Improved the LISTPKI display and functionality adding more information on certificate status and the ability to apply models to displayed information. [Details](../transport_security_start_here/certificates2/pkiutil_cli_intro/using_the_listpki_command)
...
-   \[CORE\] You can now use PKIUTIL PKIEXT to export a key in the PKCS#8 format. [Details](../transport_security_start_here/certificates2/pkiutil_cli_intro/pkiext)
...
-   \[CORE\] Added a PASSWORD for the PKIEXT command, which enables you to export the user certificate and key in PKCS12 format. [Details](../transport_security_start_here/certificates2/pkiutil_cli_intro/pkiext)
...
-   \[CORE\] Added new parameters, TYPE and ID, to the PKIEXT command. SP1 [Details](../transport_security_start_here/certificates2/pkiutil_cli_intro/pkiext)
...
-   \[CORE\] A new command PKIENTITY enables you enlarge the list of certificate authority IDs for each security configuration. [Details](../transport_security_start_here/certificates2/pkiutil_cli_intro/pkientity)
...
-   \[SSL\] Increased X.509 certificate support to 4 KB in size. [Details](../transport_security_start_here/certificates2/certificate_concepts)
