{
    ...
    "linkTitle": "Changelog",
    "weight": "40"
}# <span id="top"></span>Changelog



Transfer CFT <span>3.9</span>



-   \[CORE\] Added support for Google Cloud Storage. [Details](administration/google_cloud.htm)

-   \[AM\] Enhanced Internal Access Management to use roles and privileges defined in CFTPARM (as type CFTROLE and CFTPRIV objects) providing more flexibility than simply predefined roles. [Details](internal_access_mgt/uconf_internal_am.htm)

-   \[UI\] The user interface additionally supports French, Portuguese, and Spanish.

-   \[UI\] You can customize and resize the columns for the Transfer page in the user interface. [Details](Transfers/Transfer_states/Managing_transfer_states.htm)

-   \[CORE\] Added the CFTUIPREF object to customize Transfer page columns and filters. [Details](Command_summary.htm#CFTUIPREF)
...
-   \[CORE\] Enabled the cache feature by default. The default value for <span>cft.server.parm.cache\_size</span> is now 5000 instead of zero. [Details](migration/mig_impact_considerations.htm#parmcache)
...
-   \[CORE\] Modified the minimum CFTLOG <span>length </span>parameter. [Details](CFTUTIL/Conf/CFTLOG.htm)
...
-   \[CORE\] Added the cft.cftlog.switch\_on\_start parameter to enable the automatic LOG switch when Transfer CFT starts. When <span>cft.cftlog.switch\_on\_start=No</span>, the log file switches once per day instead of at each start. [Details](GUI/Conf/housekeeping_logs.htm)
...
-   \[CORE\] Added the <span>cg.certificate.governance.csr\_dn</span> parameter to enable users to customize the DN. Flow Manager [Details](docker/register_fm.htm), Central Governance [Details](central_governance/register_CG.htm)
...
-   \[CORE\] Support Ceph Object Storage with S3. [Details](administration/amazon_s3.htm#Use)
...
-   \[CORE\] You can automatically move a file to a specified directory following a successful file transfer either with folder monitoring [Details](CFTUTIL/Parameter_index/archivedir.htm), or without folder monitoring using FACTION [Details](CFTUTIL/Parameter_index/faction.htm)
...
-   \[SECURITY\] Added support for 4096-bit key for certificates generated during registration with <span>Central Governance</span> (see *Change private key length*). [Details](central_governance/register_CG.htm)
...
-   \[CORE\] Developed and added Transfer CFT features to the web browser user interface, including Transfer CFT sever management (check the status, start, stop, and restart). See the [User interface comparison](GUI/user_interfaces.htm) table.
...
-   \[CORE\] You can now implement Transfer CFT in a Microsoft Azure environment. [Details](architecture/datasheet.htm#Virtuali)

-   \[CORE\] You can integrate GlusterFS as storage for file transfers. [Details](cft_installation/prerequisites_unix/shared_file_prereq_ux.htm#Standalo)

-   \[UNIX\] Added parameters that allow you to configure the Transfer CFT <span>systemd</span> service when using Central Governance. [Details](UNIX/UNIX_operations/systemd_service_ux.htm)
...
-   \[CORE\] Amazon S3 can now be integrated with you SFTP flows. [Details](administration/sftp/sftp_intro.htm#Using)
...
-   \[CORE\] Folder monitoring run-time customization with support for a new symbolic variable syntax. [Details](administration/folder_monitoring/configure_folder_monitoring.htm#Customiz)
...
-   \[CORE\] Updated some default values for the CFTTCP, CFTNET, CFTPART and CFTPARM commands. [Details](CFTUTIL/Parameter_index/updated_defaults.htm)
...
-   \[CORE\] You may use only one key for multi-node installations. SP2 [Details](multi_node/about_multinode.htm#Prerequi)
...
-   \[CORE\] You can now use PKIUTIL PKIKEY or PKIKUTIL PKICER to handle encrypted PEM private keys. SP1 [Details](administration/sftp/pki_keys_use.htm)

-   \[CORE\] Added keyboard shortcuts to improve accessibility in the Transfer CFT UI. SP1 [Details](GUI/web_copilot_ui.htm)

-   \[CORE\] In the SWAITCAT command, added support for the T value in the PHASES parameter, and in the SEND and RECV commands added support for the T value in the WPHASES parameter. SP1 PHASES [Details](CFTUTIL/Parameter_index/phases.htm), WPHASES [Details](CFTUTIL/Parameter_index/wphases.htm)

-   \[CORE\] Added the requester JOBNAME in the <span>CFTR12I</span> message for SEND and RECEIVE commands (log format V24). Added requester JOBNAME in the <span>CFTS20I </span>message (when the communication file row number is deleted). SP1 CFTR12I [Details](Troubleshooting/Messages_and_Codes/CFTR_messages.htm#CFTR12I), CFTS20I [Details](Troubleshooting/Messages_and_Codes/CFTS_messages.htm#CFTS20I)
...
-   \[LINUX\] Added support for Amazon Web Services Elastic File System (EFS). [Details](Prots/internet/aws_efs.htm)
...
-   \[CORE\] Added NIDT attribute as catalog selection criteria. [Details](CFTUTIL/Parameter_index/nidt.htm)



<span>Transfer CFT</span> 3.2.4
...
-   \[CORE\] You can now customize the SSL certificate distinguished name (DN) generated during Central Governance registration. SP1 [Details](central_governance/cg_register_overview.htm#Customiz)

-   \[CORE\] The Copilot server automatically uses the SSL certificate, generated during <span>Central Governance</span> registration, for SSL connections. SP1 [Details](administration/manage_copilot.htm)
...
-   \[<span>UNIX\] Support product updates using <span>Central Governance</span> when the system user control is enabled.</span>

-   \[CORE\] Support regular expressions for multi-pattern groups of files. [Details](Transfers/Subm_transfers/Send_group_of_files_CL.htm#Create)
...
-   \[z/OS\] Added support for cft.server.exec\_as\_user. [Details](administration/rights/user_rights_file_rights.htm#Set2)

-   \[AM\] Enhanced the <span>Transfer CFT</span> to PassPort decoupling by adding a new process to update the persistent cache. [Details](uconf/unconf_access_management.htm)

-   \[CORE\] Transfer CFT sends notifications to the Sentinel server only for errors. [Details](Sentinel/trk_parms.htm)

-   \[CORE\] Added HOST information to the message CFTH56I. [Details](Troubleshooting/Messages_and_Codes/CFTH_messages.htm#CFTH56I)
...
-   \[CORE\] Documented symbolic variable used to reconstitute a filename on reception. [Details](CFTUTIL/Parameter_index/symbolic_variables.htm#Example)
...
-   \[CORE\] Added new parameters [SY](CFTUTIL/Parameter_index/sy.htm) and [RY](CFTUTIL/Parameter_index/ry.htm), and UCONF parameters cft.purge.sy and cft.purge.ry, to automatically purge transfers in the Y (post-processing phase) state. [Details](administration/housekeeping_catalog.htm)
...
-   \[CORE\] Added new parameters [WPHASESTEPS](CFTUTIL/Parameter_index/wphasesteps.htm) and [WPHASE](CFTUTIL/Parameter_index/wphases.htm) for the SEND/RECV commands.

-   \[CORE\] Added a new parameter FILENOTFOUND for the CFTSEND/CFTRECV objects and the SEND/RECV commands. [Details](CFTUTIL/Parameter_index/filenotfound.htm)

-   \[CORE\] Added a new parameter FILENOTFOUND for the SEND and RECV commands. [Details](CFTUTIL/Parameter_index/filenotfound.htm)
...
-   \[CORE\] Dynamically add, remove, enable, or disable a logical folder to monitor in the Transfer CFT runtime. [Details](administration/folder_monitoring/folder_monitor_uconf.htm#Modifying_existing_configuration)
...
<span>Transfer CFT</span> 3.1.3



-   \[CORE\] Added a new UCONF parameter cg.configuration\_policy. SP4 [Details](central_governance/cg_register_overview.htm)

-   \[CORE\] Support for the NCHARSET and FCHARSET "//IGNORE" functionality on all platforms. SP4 [Details](Transfers/use_extended_character_sets.htm#Using)
...
-   \[CG\] SP and patch deployment via <span>Central Governance</span>. *Unix/Windows only*[Details](central_governance/cg_postregister.htm)

-   \[CG\] <span>Central Governance</span> support for additional platforms z/OS and IBM i. [Details](central_governance/governance_overview.htm)
...
<span>Transfer CFT</span> 3.1.2



-   \[CORE\] Added Express Package functionality to generate pre-configured <span>Transfer CFT</span> installation packages. SP1 Details
...
-   \[CORE\] <span>Axway</span> Central Governance integration. [Details](architecture/overview/c_cg_concepts.htm)

-   \[CORE\] Enabled folder monitoring. [Details](administration/folder_monitoring/folder_monitor_uconf.htm)

-   \[SSL\] <span>Axway</span> Secure Relay integration. [Details](secure_relay/sr_overview.htm)

-   \[COMS\] Synchronous Communication Media in multi-node architecture. [Details](multi_node/about_multinode.htm)

-   \[NET\] Support for pTCP in a multi-node architecture. Backported 3.0.1 SP2 [Details](uconf/uconf_acceleration.htm#uconf_ptcp)

-   \[AM\] <span>Axway</span> PassPort AM local cache. [Details](uconf/unconf_access_management.htm)
...
-   \[CORE\] Added EXECRALL post-processing parameter to the receive command. Backported 3.0.1 SP4 and 2.7.1 SP8. [Details](CFTUTIL/Parameter_index/execrall.htm)

-   \[CORE\] Added requester mode transfer parameter maxduration as a transfer timer. [Details](CFTUTIL/Parameter_index/maxduration.htm)
...
-   \[CORE\] Enable SEND or RECV with no IDF. [Details](CFTUTIL/Parameter_index/idf.htm#IDF_send_recv)
...
<span>Transfer CFT</span> 3.0.1



-   \[DOC\] Added UCONF directory listing. SP4 [Details](uconf/uconf_directory.htm)

-   \[NET\] Support for a newer version of pTCP. <span>Note</span>: See compatibility restrictions with previous versions of <span>Transfer CFT</span>. SP2 [Details](uconf/uconf_acceleration.htm#uconf_ptcp)
...
-   \[CORE\] Multi-node architecture (active/active high availability, horizontal scalability, traffic management). [Details](multi_node/about_multinode.htm)
    ...
    -   \[CORE\] Multi-node LISTLOG. [Details](multi_node/multi_node_commands.htm#Multi%20N%20Listlog)

    -   \[CORE\] Multi-node DISPLAY and LISTCAT. [Details](multi_node/multi_node_commands.htm#Multi%20N%20Display)

    -   \[CORE\] Multi-node LISTNODE. [Details](multi_node/multi_node_commands.htm#Multi%20N%20Listnode)

    -   \[CORE\] New commands to enable/disable nodes. [Details](multi_node/multi_node_commands.htm#Multi%20N%20enable%20disable)
...
-   \[AM\] Internal Access Management added (uconf:am.type=internal). Backported, see 2.7.1 and 2.6.4. [Details](internal_access_mgt/uconf_internal_am.htm)
...
-   \[CORE\] Executable file to retrieve system details CFTTELL. [Details](CFTUTIL/Admin/cfttell.htm)

-   \[GUI\] Updated Wizards. Details

-   \[GUI\] CFT\_support is generated directly from Copilot. [Details](Troubleshooting/support_tools.htm)

-   \[NET\] Support for NFSv4. [Details](Prots/internet/nfsv4.htm)
...
-   \[NET\] Support for a newer version of pTCP. <span>Note</span>: See compatibility restrictions with previous versions of Transfer CFT. SP2 [Details](uconf/uconf_protocols_and_networks.htm)



<span>Transfer CFT</span> 2.7.1



-   \[NET\] Support for more recent version of pTCP. <span>Note</span>: Compatibility restrictions with lower Transfer CFT versions. SP6 [Details](uconf/uconf_protocols_and_networks.htm)
...
-   \[NET\] Add IPv6 support (<span>uconf:cft.ipv6.\*</span>). [UCONF](uconf/uconf_protocols_and_networks.htm), [Details](Prots/internet/IPv6.htm)

-   \[NET\] Transfer acceleration using UDT, pTCP (<span>uconf:acceleration.\*</span>). [Details](uconf/uconf_acceleration.htm)
...
-   \[CORE\] Reload the dynamic unified configuration parameters (<span>CFTUTIL RECONFIG TYPE=UCONF</span>). [Details](CFTUTIL/Monitoring/RECONFIG.htm)

-   \[CORE\] Dynamically increase catalog size (<span>CFTUTIL RECONFIG TYPE=CAT,RECNB=xxx</span>). [Details](CFTUTIL/Monitoring/RECONFIG.htm)

-   \[CORE\] Dynamic catalog purge. (<span>uconf:cft.purge.r\*</span>|<span>uconf:cft.purge.s\*</span>) [Details](CFTUTIL/Monitoring/Purge_catalog.htm), [UCONF](uconf/uconf_parameters.htm)

-   \[CORE\] Display key information in <span>CFTUTIL ABOUT</span>. [Details](CFTUTIL/Admin/about_command.htm)

-   \[CORE\] Customizable network sessions (<span>uconf:cft.server.max\_session</span>). [UCONF](uconf/uconf_parameters.htm)

-   \[CORE\] Adaptive memory consumption based on the MAXTRANS parameter and <span>uconf:cft.server.max\_session</span>.
...
-   \[SENTINEL\] Integrated Sentinel Heartbeat (<span>uconf:sentinel.heartbeat.\*</span>). [UCONF](uconf/uconf_sentinel.htm)

-   \[SENTINEL\] Sentinel transfer progress notifications. (<span>uconf:sentinel.xfb.transfer\_progress\_period</span>).  [UCONF](uconf/uconf_sentinel.htm)

-   \[NAVIGATOR\] Transfer CFT Navigator self-registration (<span>uconf:navigator.\*</span>). UCONF

-   \[GOVERNANCE\] Start/stop scripts. [UNIX](UNIX/UNIX_operations/Running_CFT/Configuring_CFT.htm), [Windows](Windows/Windows/Running_CFT_for_the_first_time_Windows.htm)
...
-   \[SENTINEL\] Added the <span>Fill RecordFormat</span> field. Details

-   \[SENTINEL\] Added <span>Fill ApplicationName</span> field with [uconf](uconf/uconf_parameters.htm):sentinel.trkident. Details
...
-   \[SSL\] Authenticated connection to PassPort PKI Server ([uconf](uconf/uconf_parameters.htm):pki.passport.login, uconf:pki.passport.password). [Details](GUI/Conf/PassPort_PS_connection.htm)
...
-   \[AM\] (Unix/Windows) Connections to PassPort AM can now be secured ([uconf](uconf/uconf_parameters.htm):am.passport.use\_ssl=Yes, uconf:am.passport.ca\_cert). [Details](Security/Admin_sec/PassPort_AM/Configure_SSL_for_PassPort_AM.htm)
...
-   \[SYST\] (Windows) Manual installation of Service Mode using <span>cscript /nologo cftsrvin.vbs</span>. [Details](Windows/Windows/Running_CFT_for_the_first_time_Windows.htm)
...
-   \[SSL\] Added [PassPort PKI](Security/Transport/PKI_exits/Passport_PKI_server_integration.htm) server support ([uconf](uconf/uconf_parameters.htm): pki.type=passport, uconf:pki.passport.\*
...
-   \[CORE\] Added a new transfer scheduler. [Details](Transfers/Trans_concepts/Transfer_sequencing.htm)
