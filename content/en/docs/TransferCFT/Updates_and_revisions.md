...
- \[CORE\] Enabled the cache feature by default. The default value for cft.server.parm.cache\_size is now 5000 instead of zero. [Details](../cft_intro_install/mig_impact_considerations#parmcache)
