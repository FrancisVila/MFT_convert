...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">For details on starting in your specific operating system, refer to the corresponding Transfer CFT <span>3.9</span> <i>Installation Guide</i>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">When the ‘cft.mvs.copilot.check_apf’ uconf variable is set to ‘Yes’, CFTCOPL must be APF authorized to start.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">CFTCOPL must be APF authorized to start if the UCONF <span>cft.mvs.copilot.check_apf </span>variable is set to <span>Yes</span>. Otherwise, the  Transfer CFT log displays <span>CFTI42E Copilot must be APF-authorized</span>.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Enter an integer for the delay in seconds. </p>
            <p>60 = default </p>
            <p>0 = no keep-alive</p>
         </td>
      </tr>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>Enter an integer for the timeout in minutes. </p>
            <ul>
...
Use these parameter to define the Transfer CFT Web Services. See also [Setting up Web Services](../../cft_intro_install/about_this_document_ibmi/using_apis/about_web_services).
...
in seconds. The Transfer CFT Copilot server checks the request status  in catalog every retry_delay seconds.                </li>
      ...
      <tr>
         ...
         <td>30         </td>
         <td>
            <p>The default value of the <a href="../../app_integration_intro/using_apis/api_intro/api_commands">apiTimeout</a> parameter as defined in the request URL.</p>
...
<table align="center" cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>conf/pki/&lt;my_certificate&gt;.p12</p>
         </td>
      </tr>
      <tr>
         <td>
...
<table align="center" cellspacing="0">
   ...
   <tbody>
      <tr>
         ...
         <td>
            <p>conf/pki /&lt;my_certificate&gt;.der <i>or</i> .pem</p>
         </td>
      </tr>
      <tr>
         <td>
      ...
      <tr>
         ...
         <td>
            <p>conf/pki /&lt;my_key&gt;.der <i>or</i> .pem</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Key password, which is mandatory if the key file is encrypted PKCS#8</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table align="center" cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         <td>
            <p><a name="copilot.ssl.SslCipherSuites"></a>copilot.ssl.SslCipherSuites</p>
            <p> </p>
         </td>
         <td>
            <p>A comma separated list of cipher suites accepted by the Transfer CFT Copilot server, for example: “47, 10, 9, 2”.</p>
            <p>See the <a href="../../transport_security_start_here/manage_cipher_suites">Supported cipher suites</a> for details.</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p><span>keytool </span><span>–</span><span>importcert</span>
</p>
            <p>   -trustcacerts</p>
            <p>   -alias AXWMFTCA</p>
            <p><span>   -file &lt;my_root_certificate&gt;</span><span>.der</span>
</p>
            <p>   -storepass changeit<span>-keystore </span><span>&lt;keystore&gt;</span></p>
         </td>
      </tr>
   </tbody>
</table>
