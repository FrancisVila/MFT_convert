{
    "title": "System user auditing",
    "linkTitle": "User auditing",
    "weight": "200"
...
Each string in the audit log file provides context for an action, the “when, status ,who, where, type, and what”.
...
This is the type of action performed. The possible values are:
&lt;/p&gt;
...
This is a detailed description of the action. See the following section for a complete list of actions.
