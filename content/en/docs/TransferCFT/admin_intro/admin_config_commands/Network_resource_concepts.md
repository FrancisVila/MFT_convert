...
-   Defines a network
    resource which, for the Transfer CFT, is an entity through which connections
    can be established
...
-   Parameters used
    to manage the Transfer CFT internal facilities: control of connection
...
from the check performed during Transfer CFT execution. When Transfer
...
Transfer CFT network resources. CFTNET also supplies the Transfer CFT
...
-   Network
    location of the Transfer CFT partner
-   Time slots
...
-   The resources
    which can be used by Transfer CFT
