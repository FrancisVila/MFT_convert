...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">In general, the 
 parameters beginning with an <i>S</i> control the send transfers operation, and 
 those beginning with an <i>R</i> control the receive transfers operation. This does 
