...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The commands listed in this section  apply generally to all supported platforms for this version, except for <span>Transfer CFT</span> z/OS. For more information, please refer to the OS-specific <span>Installation Guide</span>.         </td>
      </tr>
</table>
