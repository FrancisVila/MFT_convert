   ...
   <col/>
      <tr>
         <td>
            ...
            <p> 12/10/19 15:53:21  <b>CFTC13E</b> Catalog resize (140 --&gt; 210) reached max before expansion</p>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Transfers in phase (Y) and phasestep (D) are not purged when purging the catalog. To purge these records, you must execute an END command that modifies the state  to (X).         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>UCONFSET id=cft.purge.sx, value=10D</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The amount of time is entered in days (x or xD), in hours (xH) or in minutes (xM). If set to -1, the CFTCAT value is used.         </td>
      </tr>
</table>
