...
You can download this page as a PDF [here](../pdf_library/Transfer_CFT_UCONF.pdf).
...
Example when <span>aws.credientials=<span>Test</span></span>
...
aws.credentials = <span>Test</span>



aws.credentials.<span>test</span>.access\_key\_id =



aws.credentials.<span>test</span>.secret\_access\_key = \*\*\*\*\*\*\*\*
...
<td data-mc-autonum="&lt;b&gt;Caution  &lt;/b&gt;" data-valign="top">Do not modify the UCONF dictionary located in the home directory unless specifically directed to do so by Axway.</td>
</tr>
</tbody>
</table>
