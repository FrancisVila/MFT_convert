...
To disable the use of the default IDF, set the UCONF value: <span>cft.default\_idf.enable=no</span>



This value is taken into account after issuing a <span>reconfig </span>command or a <span>Transfer CFT</span> restart.
