...
<table data-cellspacing="0">
   ...
   <tbody>
      <tr class="odd">
         ...
         <td>Modifies the number of parallel transfers. See <a href="../CFTUTIL/Parameter_index/trantask.htm">trantask</a>.         </td>
      </tr>
   </tbody>
</table>
   ...
   <tbody>
      ...
      <tr class="even">
         ...
         <td>            <p>Defines the transfer states:</p>
            ...
            <p><span>Note</span>: Uconf:cft.state_compat also impacts the <a href="../Transfers/processing/ack_phase.htm">acknowledgement</a> behavior if ackstate is set to ignore.</p>         </td>
      </tr>
   </tbody>
</table>
