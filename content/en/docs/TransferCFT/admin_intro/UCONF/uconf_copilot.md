...
Refer to the [UCONF parameters](uconf_directory.htm) table for information on <span>copilot.\*.unix </span>parameters.
...
Use this parameter to define the <span>Transfer CFT</span> Web Services. See also [Setting up Web Services](../Prog/web_services/about_web_services.htm).
