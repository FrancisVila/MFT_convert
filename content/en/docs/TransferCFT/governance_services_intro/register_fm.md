...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>uconfset id=cg.metadata.agent.value, value=&lt;agent_host_FQDN&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Transfer CFT can use the Flow Manager Agent as the outgoing HTTP proxy when connecting to the Flow Manager SaaS.         </td>
      </tr>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>PKIUTIL pkicer  id = 'FM_CA_Alias',</p>
            <p>        iform    = 'PEM',</p>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>uconfset id=cg.ca_cert_id, value=&lt;FM_CA_Alias&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>uconfset id=cg.host, value=&lt;Flow_Manager_FQDN&gt; </p>
            <p>uconfset id=cg.port, value=&lt;FM_port&gt;</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If the shared secret is incorrect, <span>Transfer CFT</span> may be rejected with a 403 HTTP code. If this happens, the <span>cg.enable </span>mode becomes disabled on your Transfer CFT to avoid sending repeat requests to Flow Manager.         </td>
      </tr>
</table>
