...
<table data-cellpadding="0" data-cellspacing="0">
   <tbody>
      <tr class="odd">
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" data-valign="top">All role and permission definitions are stored in CFTPARM.         </td>
      </tr>
   </tbody>
</table>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>CFTROLE      ID          = '<span>TRANSFER-ROLE</span>',</p>
            <p>             COMMENT     = '',</p>
            <p>/*           ALIASES     = ( ) ,*/</p>
...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd">
         <td>            <p>CFTROLE      ID          = '<span>ADMIN_ROLE</span>',</p>
            <p>              COMMENT     = 'Administrator role for Production Transfer CFT Windows',</p>
            <p><span>              PRIVS       = ('<span>PRIV-CONN-INTERFACES</span>',               </span></p>
