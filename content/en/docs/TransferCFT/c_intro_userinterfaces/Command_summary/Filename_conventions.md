...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">When the file sent corresponds exactly to the one the partner 
...
<table cellspacing="0">
   ...
   <thead>
      ...
      <tr data-mc-conditions="">
         <td data-mc-conditions="" valign="top" width="15%">
            <p>CFTSEND </p>
         </td>
         <td data-mc-conditions="" valign="top" width="31%">
            <p>0 or -n </p>
         </td>
         <td data-mc-conditions="" valign="top" width="24%">
            <p>IMPL=YES </p>
         </td>
         <td data-mc-conditions="" valign="top" width="30%">
            <p>at the start of the transfer </p>
         </td>
      </tr>
      <tr data-mc-conditions="">
         <td data-mc-conditions="" valign="top" width="15%">
         ...
         <td data-mc-conditions="" valign="top" width="30%">
            <p>when the request is placed in the catalog </p>
         </td>
      </tr>
      <tr>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>//ST1 EXEC PGM=USER<br/>//DD1 DD DSN=FIL(-1)<br/>//ST4 EXEC PGM=CFTUTIL<br/>   SEND     FNAME=FIL(-1)         </td>
      </tr>
   </tbody>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Refer to the table of <a href="platform_specific_characters_and_functions.htm">platform-specific characters</a>  that corresponds to your operating system. 
          </td>
      </tr>
</table>
