...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>CHAR NAME = IDT, SIZE=12</p>
            <p>QUERY PART = PSITC001, DIRECT = RECV,</p>
            <p>NAME=IDT,FIELD=IDT</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>WAITCAT PART = PSITC001, DIRECT = RECV, DURING = 30,</p>
            <p>SCANTIME = 1</p>
            <p>PRINT MSG='The return code for WAIT is : %_CMDRET%'</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>
            <p>TEST PART = PSITC001, DIRECT = RECV,</p>
            <p>PRINT MSG='The test return code is: %_CMDRET%'</p>
         </td>
      </tr>
   </tbody>
</table>
