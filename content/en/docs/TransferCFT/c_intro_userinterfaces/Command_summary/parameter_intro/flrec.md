...
The Transfer CFT sender maps the virtual file attributes according to the SEND,
...
#### <span id="flrecl_CFTRECV"></span>CFTRECV, RECV
...
#### <span id="flrecl_CFTSEND"></span>CFTSEND, SEND
