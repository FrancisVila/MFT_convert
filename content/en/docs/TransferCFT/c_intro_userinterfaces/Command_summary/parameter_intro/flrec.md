...
The <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span> sender maps the virtual file attributes according to the SEND,
