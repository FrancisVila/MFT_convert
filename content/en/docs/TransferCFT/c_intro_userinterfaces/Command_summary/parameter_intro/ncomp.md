...
<table cellspacing="0" width="90%">
   ...
   <col/>
      <tr valign="top">
         <td width="26%">
            <p>PeSIT D CFT profile<br/><br/>PeSIT E</p>
         </td>
         <td width="74%">
            <p>This parameter should only be used for transfers in PeSIT 
 (with the profile or version indicated when the value of the SCOMP parameter 
 of the CFTPROT command is too high for the model file in question).</p>
         </td>
      </tr>
      <tr valign="top">
         <td width="26%">
         ...
         <td width="74%">
            <p>This parameter is used to inhibit compression 
