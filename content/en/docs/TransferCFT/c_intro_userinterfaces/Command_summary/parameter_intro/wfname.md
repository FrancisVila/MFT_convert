{
    ...
    "linkTitle": "wfname",
    "weight": "3780"
}### <span id="wfname"></span>wfname

#### <span id="wfname_CFTRECV"></span>CFTRECV, RECV
...
to each operating system. Refer to the Transfer CFT *"Operations
...
<table width="90%">
   ...
   <col/>
      <tr>
         ...
         <td width="50%">
            <p>This parameter is mandatory if the receiver file is a version 
 file (in particular for operation in the open mode and when the sender 
 sends an NFNAME corresponding to a GDG name).</p>
         </td>
      </tr>
</table>
...
#### <span id="wfname_CFTSEND"></span>CFTSEND, SEND
