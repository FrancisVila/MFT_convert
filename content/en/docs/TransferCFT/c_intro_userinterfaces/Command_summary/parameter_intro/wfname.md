...
to each operating system. Refer to the <span class="mc-variable axway_variables.Component_Short_Name variable">Transfer CFT</span> *"Operations
...
<table>
   ...
   <tbody>
      <tr>
         <td><p>MVS, VMS</p>         </td>
         <td><p>This parameter is mandatory if the receiver file is a version
