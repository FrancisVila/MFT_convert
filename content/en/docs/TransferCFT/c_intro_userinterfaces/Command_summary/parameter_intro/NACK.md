...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">When performing file transfers between two <span>Transfer CFT</span>s, negative acknowledgments are sent regardless of the NACK setting.         </td>
      </tr>
</table>
