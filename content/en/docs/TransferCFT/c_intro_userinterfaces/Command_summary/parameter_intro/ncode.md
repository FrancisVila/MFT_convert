{
    ...
    "linkTitle": "ncode",
    "weight": "2140"
}### <span id="ncode"></span>ncode

#### <span id="ncode_CFTSEND"></span>CFTSEND, SEND
...
-   If NCODE is
    ...
    whether by means of an external translation table or the Transfer CFT
...
#### <span id="ncode_CFTXLATE"></span>CFTXLATE
