...
<table data-cellspacing="0">
   <tbody>
      <tr class="odd" data-valign="top">
         <td width="23.061%">            <p>CID = string</p>         </td>
...
must be specified if the IKNAME parameter is set. <em>only in command line</em></p>         </td>
      ...
      <tr class="even" data-valign="top">
         ...
         <td width="54.815%">            <p>File from which the private key, which is associated with
...
viewed. <em>only in command line</em></p>         </td>
      ...
      <tr class="odd" data-valign="top">
         ...
         <td width="54.815%">            <p>If you use a password, the PKICER certificate is exported in PKCS#12 format (rather than KPRIV).</p>
            <p><em>Only available in command line</em></p>         </td>
      </tr>
      <tr class="even" data-valign="top">
         <td width="23.061%">            <p>[ROOTCID = string1..8]</p>         </td>
