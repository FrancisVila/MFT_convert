{
    "title": "SSH Security Profiles - CFTSSH",
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">When using the SFTP protocol, the CFTSSH definition contains the SSH connection parameters for  server or client mode.         </td>
      </tr>
</table>
...
<table cellspacing="0">
 ...
 ..)}</p>
         ...
         <td colspan="1" rowspan="1" width="47.156%">
            <p>List of allowed ciphers (encryption methods). </p>
 ...
 negotiated.</p>
      ...
      <tr valign="top">
         ...
         <td width="47.156%">
<p width="47.156%">When DIRECT=SERVER</p>
<p width="47.156%">Key Id  containing the client public key (RSA). When defined, the Transfer CFT server checks that the client public key referenced in CLIPUBKEY matches the public key provided by the client. If an error occurs, the connection is rejected with a DIAGI 433.</p>
         </td>
      </tr>
      <tr valign="top">
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="47.156%">
            <p>The security profile is applicable in this mode (SERVER).</p>
         </td>
      </tr>
      <tr valign="top">
         <td width="28.19%">HMAC         </td>
         <td width="47.156%">
            <p> List of accepted HMAC (keyed-hash message authentication code). </p>
            <ul>
               <li>Choose from the following: hmac-sha2-512, hmac-sha2-256, hmac-sha1, none.<br/>               </li>
               <li>If the field is empty, the default list is hmac-sha2-512, hmac-sha2-256, hmac-sha1.               </li>
            </ul>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="28.19%">KEYEXCHG         </td>
         <td colspan="1" rowspan="1" width="47.156%">
<p colspan="1" rowspan="1" width="47.156%">List of key exchange methods to use. </p>
<p colspan="1" rowspan="1" width="47.156%">Choose from the following: curve25519-sha256@libssh.org, ecdh-sha2-nistp256, diffie-hellman-group14-sha1, diffie-hellman-group1-sha1.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="28.19%">
 ...
 are required.</p>
      ...
      <tr valign="top">
         ...
         <td width="47.156%">
<p width="47.156%">When DIRECT=SERVER:</p>
<p width="47.156%">Key Id  containing the server private key (RSA) to use with key authentication.</p>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
 ...
 negotiated.</p>
      ...
      <tr valign="top">
         ...
         <td width="47.156%">
               <li> When DIRECT=CLIENT               </li>
               <li>Key Id  containing the client private key (RSA) to use with key authentication. When defined, Transfer CFT uses key authentication. If an error occurs, the connection is rejected with a DIAGI 433.               </li>
         </td>
      </tr>
      <tr valign="top">
         <td width="28.19%">Comment         </td>
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="47.156%">
            <p>The security profile is applicable in this mode (CLIENT). </p>
         </td>
      </tr>
      <tr valign="top">
         <td width="28.19%">HMAC         </td>
      ...
      <tr valign="top">
         <td colspan="1" rowspan="1" width="28.19%">KEYEXCHG         </td>
         <td colspan="1" rowspan="1" width="47.156%">List of key exchange methods to use. Choose from the following: curve25519-sha256@libssh.org, ecdh-sha2-nistp256, diffie-hellman-group14-sha1, diffie-hellman-group1-sha1.         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="28.19%">
            <p>MODE = {REPLACE | 
 ...
 are required.</p>
      ...
      <tr valign="top">
         ...
         <td width="47.156%">
<p width="47.156%">When DIRECT=CLIENT:</p>
<p width="47.156%">Key Id  containing the server public key (RSA) for the server. When defined, the Transfer CFT client checks that the public key referenced by SRVPUBKEY matches the key provided by the server. </p>
<p width="47.156%">If an error occurs, the connection is rejected with a DIAGI 264.</p>
         </td>
      </tr>
   </tbody>
</table>
