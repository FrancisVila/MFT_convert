...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td>CFTAPPL    <br/>     [MODE       =     
 {CREATE | DELETE | REPLACE},]<br/>     ID          =     
 identifier,<br/>     USERID      =     
 identifier,<br/>     [GROUPID    =     
 identifier,]<br/>     [DIRECT     =     
 {BOTH | RECV | SEND}]         </td>
      </tr>
   </tbody>
</table>
...
## <span id="Implementation"></span>Implementing
...
### <span id="Pre_transfer_controls"></span>Pre-transfer controls
...
### <span id="Requester_sender_configuration"></span>Requester/sender configuration
...
## <span id="Rights_for_users_and_files"></span>Rights for users and files
