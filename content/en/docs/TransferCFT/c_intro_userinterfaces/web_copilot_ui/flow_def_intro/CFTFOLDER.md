 ...
 If you have more than one Folder to monitor, use a space between each logical value. </p>
      ...
      <tr>
         ...
         <td>
            ...
            <p>See  <a href="../../../../app_integration_intro/intro_folder_monitor/folder_customize">Create inclusion and exclusion filters</a> for details.</p>
         </td>
      </tr>
      <tr>
         <td>RENAMEMETHOD         </td>
 ...
 - myfile.txt is renamed myfile.[20131025].txt
      ...
      <tr>
         <td>
            <p>USEFSEVENTS</p>
            <p> </p>
            <p><a href="#enable">More information</a>
</p>
         </td>
         <td>Boolean         </td>
         <td>No         </td>
      ...
      <tr>
         <td><a href="../../../command_summary/parameter_intro/userid">USERID </a>
         </td>
         <td>String          </td>
         <td>          </td>
         <td>
            ...
            <p>Identifier for a user who can scan a folder. See the section, <a href="../../../../app_integration_intro/intro_folder_monitor/configure_folder_monitoring">Folder monitoring using USERCTRL</a>.</p>
         </td>
      </tr>
   </tbody>
</table>
