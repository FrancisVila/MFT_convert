{
    "title": "Receive templates - CFTRECV ",
...
<table cellspacing="0">
   ...
   <thead>
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Local alphanumeric comment associated 
 with receive transfers.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Upper final date for activating the first 
 transfer of a cycle.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Upper limit time for activating the first 
 transfer of a cycle.</p>
         </td>
      </tr>
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Automatic deletion of the catalog entries 
 in the "X" phase (done) for the corresponding IDF.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Identifier of the CFTEXIT command associated 
 with this transfer.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Action on the file for a receive transfer.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>This parameter (in bytes) controls the 
 ...
 buffer size.</p>
      ...
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/fcharset">FCHARSET</a>
         </td>
         <td width="80.018%">Defines the local file  encoding.         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/fcheck">FCHECK</a>
</p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Checks record length attributes.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Code of the receiver file data (local 
 data code).</p>
         </td>
      </tr>
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Presence check indicator of the receiver 
 file used to determine the action of the Transfer CFT monitor.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Key position relative to 0 in the record 
 of an indexed file.</p>
         </td>
      </tr>
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/flowname">FLOWNAME</a>
         </td>
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Name of the physical receiver file (filename 
 or complete pathname) of the directory.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Determines the priority with which the 
 parameters set in CFTRECV are taken into account relative to the parameters 
 set in an associated RECV command.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
      ...
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/frecfm">FRECFM</a> </p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Record format of the receiver file.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Size of the receiver file, in K-bytes 
 (1 K-byte = 1024 bytes).</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Information completing the USERID of the 
 CFTRECV command.</p>
         </td>
      </tr>
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Local model file identifier (IDF).</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/maction">MACTION</a> </p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Action on the files transferred by COPY 
 at the time of creation.</p>
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Transfer validity limit time for the final 
 date (MAXDATE).</p>
         </td>
      </tr>
      <tr valign="top">
      ...
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/mintime">MINTIME</a>
</p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Transfer initial validity time, from the 
 first day (MINDATE).</p>
         </td>
      </tr>
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/ncharset">NCHARSET</a>
         </td>
         <td width="80.018%">Defines the destination file encoding that is used on a file 
 to encode or decode network  data.         </td>
      </tr>
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/ncode">NCODE</a>
         </td>
         <td width="80.018%">The network data code when receiving transfers. <i>Available only when using SFTP.</i>         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Compression of on-line data requested 
 by the receiver.</p>
         </td>
      </tr>
      <tr valign="top">
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Defines the destination of the messages 
 associated with the send transfer selected from the log file messages, 
 by the value of the OPERMSG parameter.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Defines the categories of transfer information 
 ...
 in the log file).</p>
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Receive request selection priority.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
      ...
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/sourceappl">SOURCEAPPL</a>
         </td>
      ...
      <tr valign="top">
         <td width="19.982%"><a href="../../../command_summary/parameter_intro/targetappl">TARGETAPPL</a>
         </td>
 ...
 file receiver application. 
      ...
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/tcycle">TCYCLE</a> </p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Transfer cycle period unit. </p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
            <p><a href="../../../command_summary/parameter_intro/trk">TRK</a> </p>
         </td>
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Specification of how much detail Transfer 
 CFT provides Sentinel about transfers. Transfer CFT sends detail about 
 the transfers in the form of tracked instances.</p>
         </td>
      </tr>
      <tr valign="top">
         <td colspan="1" rowspan="1" width="19.982%">
      ...
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Name of the temporary file used during 
 the transfer.</p>
         </td>
      </tr>
      <tr valign="top">
         ...
         <td colspan="1" rowspan="1" width="80.018%">
            <p>Identifier of the translation table used 
 for the receive transfers.</p>
         </td>
      </tr>
</table>
...
<table cellspacing="0" height="318">
   <col/>
   <col/>
      <tr>
         <td width="40.792%">
      ...
      <tr>
         ...
         <td width="59.208%">
            <p>/* IDF for source files */</p>
         </td>
      </tr>
      <tr>
         <td colspan="1" rowspan="1" width="40.792%">
            <p>FDISP = BOTH</p>
         </td>
         <td colspan="1" rowspan="1" width="59.208%">
            <p>/* already exists or not */</p>
         </td>
      </tr>
      <tr>
         <td width="40.792%">
   ...
   <col/>
      <tr>
         <td width="38.168%">
            ...
            <p>FNAME = &amp;IDT /* file as per IDT value */</p>
         </td>
      </tr>
</table>
