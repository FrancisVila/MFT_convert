...
<td width="59.777%"><p>Define the diagi catalog transfer field display:</p>
<ul>
...
<tr class="even" data-valign="top">
<td width="20.241%"><p>EMPTY</p></td>
<td width="59.777%"><p>Use this parameter to replace the default output of <span>Empty</span> values, usually empty string values.</p>
...
<tr class="even" data-valign="top">
<td width="20.241%"><p>FMODEL</p></td>
<td width="59.777%"><p>Complete name or logical name of the XML model file.</p>
...
<tr class="even" data-valign="top">
<td width="20.241%"><p>HELP</p></td>
<td width="59.777%"><p>Displays help information:</p>
<ul>
...
<tr class="odd" data-valign="top">
<td width="20.241%"><p>MODE</p></td>
<td width="59.777%"><p>This parameter is used to force a model's output mode.</p>
...
<tr class="even" data-valign="top">
<td width="20.241%"><p>NA</p></td>
<td width="59.777%"><p>Use this parameter to replace the default output of "Non
Applicable" values.  </p>
...
<tr class="even" data-valign="top">
<td width="20.241%"><p>RUSER</p></td>
<td width="59.777%"><p>Displays value as defined in the CONTENT parameter.</p></td>
</tr>
<tr class="odd" data-valign="top">
<td width="20.241%">SORTBY</td>
<td width="59.777%"><p>Use this parameter to display information in an alphabetical/alphanumberic order.</p>
<p>For example, to sort by partner name and identifier, enter:</p>
<p><span>CFTUTIL DISPLAY SORTBY=(PART,IDF)</span></p>
