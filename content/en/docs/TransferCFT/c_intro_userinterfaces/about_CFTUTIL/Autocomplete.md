{
    ...
    "weight": "170"
}<span class="mc-variable suite_variables.TransferCFTName variable">Transfer CFT</span> offers several commands and options that enable you to work more quickly and efficiently. The following sections describe:
