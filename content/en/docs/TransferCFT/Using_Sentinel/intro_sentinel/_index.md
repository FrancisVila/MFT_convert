...
For each step of each Transfer CFT{{< TransferCFT/componentshortname  >}} file transfer process, Transfer CFT{{< TransferCFT/componentshortname  >}}generates a Tracked Object instance and sends this to Sentinel. In each TO instance, the State attribute identifies the relevant step of the transfer process.
