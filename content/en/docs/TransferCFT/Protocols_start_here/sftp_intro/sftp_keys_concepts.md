...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If you are ready to generate a key pair, you can go directly to <a href="../new_pki_keys_use">Use PKIKEYGEN to generate and import a key pair</a>.         </td>
      </tr>
</table>
