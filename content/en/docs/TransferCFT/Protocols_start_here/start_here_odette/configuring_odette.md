...
<table cellspacing="0">
   ...
   <tbody>
      <tr valign="top">
         <td>
            <p>SROUT = BOTH and SRIN = SENDER </p>
         </td>
         <td width="50%">
            <p>SROUT = RECEIVER and SRIN = SENDER</p>
         </td>
      </tr>
      <tr valign="top">
         <td>
            <p>SROUT = BOTH and SRIN = RECEIVER</p>
         </td>
         <td width="50%">
            <p>SROUT = SENDER and SRIN = RECEIVER</p>
         </td>
      </tr>
      <tr valign="top">
         <td>
            <p>SRIN = BOTH and SROUT = SENDER</p>
         </td>
         <td width="50%">
            <p>SROUT = SENDER and SRIN = RECEIVER</p>
         </td>
      ...
      <tr valign="top">
         <td>
            <p>SRIN = BOTH and SROUT = RECEIVER</p>
         </td>
         <td width="50%">
            <p>SROUT = RECEIVER and SRIN = SENDER</p>
         </td>
      ...
      <tr valign="top">
         <td>
            <p>SRIN  = BOTH and SROUT = BOTH</p>
         </td>
         <td width="50%">
            <p>SROUT = BOTH and SRIN = BOTH</p>
         </td>
      </tr>
   </tbody>
</table>
