...
<table cellspacing="0">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td width="50%">
            <p> PI 11 of the file for which the message conveys the 
 acknowledgement</p>
         </td>
      </tr>
   </tbody>
...
<table cellspacing="0" width="90%">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td width="50%">
            <p>Transfer CFT refuses to perform the transfer. This value 
 has no protocol reality, since no connection request is sent</p>
         </td>
      </tr>
   </tbody>
</table>
