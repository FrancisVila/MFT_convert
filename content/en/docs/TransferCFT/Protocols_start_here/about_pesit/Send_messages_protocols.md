...
### <span id="Sending_messages_in_PeSIT"></span>Sending messages in PeSIT
...
was sent. The partner Transfer CFT interprets this message as a transfer acknowledgement.
...
## <span id="Monitoring_PeSIT_transfer_requests"></span>Monitoring PeSIT transfer requests
