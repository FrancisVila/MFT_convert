{
    ...
    "weight": "20"
}The SecureTransport {{< SecureTransport/componentversion  >}} Upgrade Guide provides instructions for upgrading {{< SecureTransport/componentshortname  >}} from previous versions of {{< SecureTransport/componentshortname  >}} to {{< SecureTransport/componentshortname  >}} {{< SecureTransport/componentversion  >}}. The upgrade paths include deployments on all supported underlying UNIX-based and Microsoft Windows platforms.
