{
    "title": "SecureTransport 5.5 Upgrade Guide",
    "linkTitle": "SecureTransport 5.5 Upgrade Guide",
    "weight": "20"
}The SecureTransport <span class="mc-variable axway_variables.Component_Version variable">5.5</span> Upgrade Guide provides instructions for upgrading <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> from previous versions of <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> to <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> <span class="mc-variable axway_variables.Component_Version variable">5.5</span>. The upgrade paths include deployments on all supported underlying UNIX-based and Microsoft Windows platforms.
