{
    ...
    "weight": "20"
}The SecureTransport 5.5 Upgrade Guide provides instructions for upgrading SecureTransport from previous versions of SecureTransport to SecureTransport 5.5. The upgrade paths include deployments on all supported underlying UNIX-based and Microsoft Windows platforms.
...
[Introduction](intro_overview1.htm)
...
[Upgrade procedures](upgrade_overview1)
