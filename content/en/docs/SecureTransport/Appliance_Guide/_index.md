{
    "title": "SecureTransport 5.5 Virtual Appliance Guide",
    "linkTitle": "SecureTransport 5.5 Appliance Guide",
    "weight": "20"
}The <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> Virtual Appliance Guide provides installation, configuration, and operation instructions for the <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> Appliance. It also provides <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> installation and upgrade instructions on <span class="mc-variable axway_variables.Company_Name variable">Axway</span> Appliances.
