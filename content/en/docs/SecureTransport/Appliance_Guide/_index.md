{
    ...
    "weight": "20"
}The {{< SecureTransport/componentshortname  >}} Virtual Appliance Guide provides installation, configuration, and operation instructions for the {{< SecureTransport/componentshortname  >}} Appliance. It also provides {{< SecureTransport/componentshortname  >}} installation and upgrade instructions on {{< SecureTransport/companyname  >}} Appliances.
