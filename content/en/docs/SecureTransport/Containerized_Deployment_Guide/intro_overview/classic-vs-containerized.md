...
<th class="TableStyle-SynchTableStyle_interop-HeadD-Column1-Header1"><p><strong>Details</strong></p>         </th>
   ...
   <tbody>
      <tr>
         ...
         <td><p>When the logs are written to <code>stdout/stderr</code>, the container runtime engine is responsible for storing and forwarding the logs. The Docker Engine has different log drivers that can send the logs to a number of different external systems for log aggregation. For more information, see section <a href="../../k8s-known-issues">Known limitations and deployment specifics</a>.</p>         </td>
      </tr>
      <tr>
...
<p>The Protocol services and the Transaction manager are not stopped gracefully when scaling down the SecureTransport Server. This may cause client transfers to interrupt unexpectedly.</p>         </td>
      ...
      <tr>
         ...
         <td><p>Update is performed by replacing the Docker Image</p>         </td>
...
<th class="TableStyle-SynchTableStyle_interop-HeadD-Column1-Header1"><p><strong>Details</strong></p>         </th>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td><p>The setup involves using at least 2 load balancers. See <a href="../../using-st-cont-delivery/initial-config#ftpPassive">FTP Passive Mode</a> for more info.</p>         </td>
      </tr>
      <tr>
         <td>Real users         </td>
         <td>Not supported         </td>
