{
    "title": "SecureTransport 5.5 Getting Started Guide",
    "linkTitle": "SecureTransport 5.5 Getting Started Guide",
    "weight": "20"
}The SecureTransport Getting Started Guide describes the initial setup and configuration of <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> using the <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> Administrator setup interface.
