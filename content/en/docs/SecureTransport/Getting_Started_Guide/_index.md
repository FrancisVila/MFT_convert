{
    ...
    "weight": "20"
}The SecureTransport Getting Started Guide describes the initial setup and configuration of {{< SecureTransport/componentshortname  >}} using the {{< SecureTransport/componentshortname  >}} Administrator setup interface.
