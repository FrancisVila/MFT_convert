...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">public class FtpBean implements UIBean {
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">/** Holds the partner hostname. */
...
/** Holds the partner port. */
    ...
    private String mPartnerUserName;</pre>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">    @Encrypted
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">/** Holds the certificate id, of the private key to authenticat with.*/
private String mClientCertificateIdLocalCertificate; 
</pre>
         </td>
      </tr>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">pluginRegister.setPluginComponent(new CustomPluginSite());
function CustomPluginSite() {
    ...
    instance.load = load;
    instance.save = save;
    return Object.seal(instance);</pre>
         </td>
      </tr>
   </tbody>
</table>
...
<table cellspacing="0">
   ...
   <tbody>
      <tr>
         <td><pre xml:space="preserve">if (siteId) {
    $.ajax({
