{
    "title": "SecureTransport 5.5 Developer Guide",
    "linkTitle": "SecureTransport 5.5 Developer Guide",
    "weight": "20"
}The SecureTransport Developer Guide provides descriptions and usage instructions for:

-   implementing custom pluggable components
-   integrating product's REST API within API Manager
-   guiding steps on Single Sign-On with REST API
-   implementing custom Address Book
