...
4.  Extract the installation files using the following command:
    ...
    <table cellspacing="0">   <col/>   <tbody>      <tr>         <td>unzip SecureTransport_5.5_Install_&lt;OS&gt;-&lt;processor&gt;_&lt;BuildNumber&gt;.zip<br/>         </td>      </tr>   </tbody></table>
...
6.  Press Enter.  
    ...
    <table cellspacing="0">   <col/>   <tbody>      <tr>         <td>[1] I accept the terms of the license agreement.<br>[2] I do not accept the terms of the license agreement.<br>Enter a number [1-2] to select an option or (Previous, Quit).<br>:&gt;2</br></br></br>         </td>      </tr>   </tbody></table>
