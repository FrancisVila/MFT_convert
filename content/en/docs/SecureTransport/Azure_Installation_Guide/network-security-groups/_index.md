...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The firewall of the instance is with higher priority than the instance’s Network Security Group. So, if you would like to use NSG, the instance’s firewall must be configured in the same way as the NSG’s rules.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The suggested configurations with Network Security Groups as stated in the current guide do not include outbound rules. For more information on best practices for the outbound rules to apply for your setup, please refer to the <span>SecureTransport</span> <i> Installation guide</i>.         </td>
      </tr>
</table>
