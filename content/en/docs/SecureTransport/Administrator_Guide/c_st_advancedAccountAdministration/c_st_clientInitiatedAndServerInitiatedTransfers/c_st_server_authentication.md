{
    ...
    "weight": "310"
}{{< SecureTransport/componentshortname  >}} provides an option to turn on the target server authentication for server‑initiated transfers. This server‑wide option is turned on by default and can be turned off using the *Transfer Sites* pane for a user account. For details, see [Manage transfer sites](../../../accounts/transfersites/t_st_transfersites#AccountsMenu_2253641766_1151145).

To manage the list of trusted certificates for server authentication, use the *Certificates* page, accessible from the **Setup** menu in the Administration Tool. For details, see [Certificates](../../../c_st_setup/c_st_certificates#SetupMenu_1217491348_1023232).
