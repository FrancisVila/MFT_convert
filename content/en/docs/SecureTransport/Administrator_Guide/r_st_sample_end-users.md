...
entityId="https://st.shibboleth.axway.int/" /&gt;
            ...
            &lt;/Header&gt;
        &lt;/TenantResolution&gt;
    &lt;/ServiceProvider&gt;</pre><pre xml:space="preserve">    &lt;!-- Identity provider definitions. Configures various aspects of 
...
attribute that provides the user name.
        ...
        &lt;SamlIdentityProvider
            ...
            &lt;Mappings&gt;
                ...
                &lt;/FilterMapping&gt;</pre><pre xml:space="preserve">                &lt;!-- With this mapping, you can rename an attribute from the 
...
of IdentityProvider element above.
                ...
                &lt;Feature key="saml-sign-logoutresponse" value="true"/&gt;</pre><pre xml:space="preserve">
            &lt;/Features&gt;
        &lt;/SamlIdentityProvider&gt;</pre><pre xml:space="preserve">        &lt;!-- A Kerberos IdP sample definition. --&gt;
        &lt;KerberosIdentityProvider
                entityId="kerberos"                
configurationUrl="C:/Axway/SecureTransport/STServer/conf/sso/krb5-login.conf"&gt;</pre><pre xml:space="preserve">        &lt;/KerberosIdentityProvider&gt;</pre><pre xml:space="preserve">    &lt;/IdentityProviders&gt;
