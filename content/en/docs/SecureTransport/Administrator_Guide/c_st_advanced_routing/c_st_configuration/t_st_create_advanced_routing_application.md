...
4.  (Optional) Use the **Assign** and **Remove** buttons to assign business units for the application. The **Business Unit List** contains the names of business units you create. For details, see [Business units](../../../c_st_advancedaccountadministration/c_st_businessunits).
