...
## <span id="Proceed"></span>Proceed with route execution on failure
...
## <span id="Transfer"></span>Transfer Settings
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Auto-completion will suggest account names and user (login) names.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You can access the first value of a given SSO attribute with name <code>attributeName</code> with the expression <code>${sso.attributes['attributeName'][0]}</code>.         </td>
      </tr>
</table>
...
To use an expression, click the edit icon (![](EditIcon.png)) next to the select box and enter the expression in field.
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Only transfer sites with proper access level will be listed. For more details see <a href="../../../accounts/transfersites" xrefformat="{paratext}">Transfer sites</a>.         </td>
      </tr>
</table>
...
The transfer profile can be selected from the listed ones or an EL expression can be used. To use an expression, click the edit icon (![](EditIcon.png)) next to the select menu and enter the expression in field.

## <span id="Configur"></span>Configure advanced PeSIT settings
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">PeSIT settings are only used for transfers over PeSIT.         </td>
      </tr>
</table>

### <span id="Store"></span>Store and forward mode
...
To preserve the predefined data encoding, do not make a data encoding selection or use the EL expression `${pesit.pi.dataEncoding}`. To use the EL expression, click the Edit icon (![](EditIcon.png)) next to the select menu and enter the expression in field.
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top"> Originator can only be changed when Store and Forward mode is set to <code>START_NEW</code>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Final destination can only be changed when Store and Forward mode is set to <code>START_NEW</code>.         </td>
      </tr>
</table>
...
## <span id="Overwrit"></span>Overwrite upload folder
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The upload folder must be created on the target file system. Otherwise, the sending of the trigger file could fail.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The upload folder of a custom Pluggable Transfer Site cannot be overwritten.          </td>
      </tr>
</table>
...
## <span id="Route"></span>Route files as
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You can access the first value of a given SSO attribute with name <code>attributeName</code> with the expression
		<code>${sso.attributes['attributeName'][0]}</code>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The path of the new file (if any) is stripped off and only the filename is left.         </td>
      </tr>
</table>

## <span id="Send"></span>Send trigger file
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The trigger file is created after the successful transfer of a file or files. The trigger file exists only in the sandbox folder. The trigger file is deleted right after it was successfully transferred to the trigger destination or destinations.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The <em>Max number of parallel transfers</em> and <em>Retry settings</em> are applied for both the data file and the trigger file.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Send File as option, in the site used to send the trigger file, is ignored and the name of the trigger file remains unchanged. Though, other Post Transmission Settings, if any, are applied over the name of the trigger file.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If <em>Send trigger file for each transferred file</em> is not selected and the sending of one or more of the transformed files fails, the trigger file is not sent even though most of the files were successfully transferred.         </td>
      </tr>
</table>
...
## <span id="Retry"></span>Retry settings
...
## <span id="Post"></span>Post Routing Action
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The post routing actions are executed in the sandbox folder only.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The output file names will be the same as the input file names. To change the file names use a Rename transformation step. To configure a Rename transformation step, refer to <a href="../../c_st_route_step_transformations/t_st_rename" xrefformat="{paratext}">Rename</a>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The <em>Archive Files On Success</em> selection will only be visible if File Archiving is enabled.  For information on the global configuration of File Archiving (including enabling File Archiving), refer to <a href="../../../c_st_setup/c_st_file_archiving/t_st_file_archiving_conf" xrefformat="{paratext}">File archiving global configuration</a>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">In order for the administrator to be able to resubmit successful outbound transfers initiated by the Send To Partner step, you must have the <em>Archive Files On Success</em> set to enabled.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The <em>Archive Files On Failure</em> selection will only be visible if File Archiving is enabled.  For information on the global configuration of File Archiving (including enabling File Archiving), refer to <a href="../../../c_st_setup/c_st_file_archiving/t_st_file_archiving_conf" xrefformat="{paratext}">File archiving global configuration</a>.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">In order for the administrator to be able to resubmit failed outbound transfers initiated by the Send To Partner step, you must have the <em>Archive Files On Success</em> set to enabled.         </td>
      </tr>
</table>
