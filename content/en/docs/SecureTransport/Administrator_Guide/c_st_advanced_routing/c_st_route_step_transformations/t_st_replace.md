{
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Currently, the Character Replace transformation accepts Unicode or ASCII as an input, or mixed input for the <strong>Find</strong> and <strong>Replace</strong> fields.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If the encoding a file is changed to IBM500, IBM037, or IBM424; the line ending of the input file should be LF and not CRLF. The CR is preserved in some cases and a new line appears between every original line. If the line ending is not LF, a Line Ending step can used before the Characters Replace step.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The comma (,) symbol can be used in ASCII only as a separator and not as find criteria. For find criteria, the comma (,) symbol can only be used  in Unicode.         </td>
      </tr>
</table>
...
1.  The number of find sequences is one or greater. The replace sequence is only 1.  
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Empty replace sequence is a valid configuration. If such is specified, when a search match is found the matching sequence will effectively be removed from the file content.         </td>
      </tr>
</table>
...
## <span id="Find/Rep"></span>Find/Replace mode
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Comma must be Unicode encoded (\002c) if used in the find sequence.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Leaving this field blank is a valid configuration. Empty replace sequence is treated as an empty character.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Comma must be Unicode encoded (\002c) if used in the replace sequence.         </td>
      </tr>
</table>

## <span id="Find/Lin"></span>Find/Line strip
