...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Step 1 is mandatory. All other steps are optional.         </td>
      </tr>
</table>
...
## <span id="Decryption"></span>Decryption Settings
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">PGP private and public keys are only searched for within the key store of the account subscribed to this route.         </td>
      </tr>
</table>
