...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">Currently, the Line Ending transformation accepts Unicode or ASCII as an input, or mixed input when the custom line ending format is selected.         </td>
      </tr>
</table>
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If the encoding a file is changed to IBM500, IBM037, or IBM424; the line ending of the input file should be LF and not CRLF. The CR is preserved in some cases and a new line appears between every original line.         </td>
      </tr>
</table>
...
## <span id="Input"></span>Input Files
...
## <span id="Source"></span>Source file settings
...
## <span id="Target"></span>Target file settings
