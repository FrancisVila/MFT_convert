...
-   Create a PeSIT transfer site to route the file to. For PeSIT transfer site creation details, refer to [PeSIT transfer sites](../../../../accounts/transfersites/transfersites-pesit).
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">To compress the file before sending it to the archive folder, add a Compress step before the second Send To Partner step.         </td>
      </tr>
</table>
