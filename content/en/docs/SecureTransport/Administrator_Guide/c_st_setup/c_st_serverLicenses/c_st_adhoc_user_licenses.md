{
    ...
    "weight": "210"
}You must install a core license with ad hoc user licenses included to enable users to compose, send, reply to, or forward messages using ST Web Client or the <span class="mc-variable axway_variables.Company_Name variable">Axway</span> Email Plug-ins. There are four categories of ad hoc user licenses:
