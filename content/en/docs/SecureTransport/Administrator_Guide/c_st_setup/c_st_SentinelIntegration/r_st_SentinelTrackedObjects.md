{
    ...
    "weight": "190"
}The tables in this topic list the attributes of the Tracked Objects used to report {{< SecureTransport/componentlongname  >}} events to {{< SecureTransport/companyname  >}} Sentinel. All the Tracked Objects have the same standard attributes. Each Tracked Object also has attributes specific to it.
...
<p>For Heartbeat: ID used to identify the {{< SecureTransport/componentshortname  >}} Server</p>         </td>
      </tr>
      <tr>
         <td><p>EVENTDATE</p>         </td>
         <td>date         </td>
      ...
      <tr>
         ...
         <td>string         </td>
         <td>IP address of the {{< SecureTransport/componentshortname  >}} host         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td><p>PRODUCTOS</p>         </td>
         <td>string         </td>
         <td>Operating system of {{< SecureTransport/componentlongname  >}} host (generated by Sentinel)         </td>
      </tr>
      <tr>
...
<th class="HeadD-Column1-Header1">Description         </th>
   ...
   <tbody>
      <tr>
         ...
         <td>string         </td>
         <td>Name of the application {{< SecureTransport/componentshortname  >}} uses         </td>
      </tr>
      <tr>
         <td><p>COREID</p>         </td>
         <td>string         </td>
      ...
      <tr>
         <td><p>LOCATION</p>         </td>
         <td>string         </td>
         <td><p>{{< SecureTransport/componentshortname  >}} by default. Its value is controlled by the server configuration option:</p>
<code>AxwaySentinel.Attributes.Attribute.value.Location                             </code>         </td>
      </tr>
      <tr>
         <td><p>MACHINE</p>         </td>
         <td>string         </td>
         <td>ST-<em>OS</em> where <em>OS</em> is the operating system of the {{< SecureTransport/componentshortname  >}} Server         </td>
      </tr>
      <tr>
         <td><p>MONITOR</p>         </td>
         <td>string         </td>
      ...
      <tr>
         ...
         <td>string         </td>
         <td>{{< SecureTransport/componentlongname  >}} version from <code>&lt;FILEDRIVEHOME&gt;/conf/version.txt</code>         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td><p>USERID</p>         </td>
         <td>string         </td>
         <td>{{< SecureTransport/componentlongname  >}} Login Name/Account Name or account name of the account that triggered the {{< SecureTransport/advancedrouting  >}} feature         </td>
      </tr>
      <tr>
...
<th class="HeadD-Column1-Header1">Description         </th>
   ...
   <tbody>
      ...
      <tr>
         <td><p>USERID</p>         </td>
         <td>string         </td>
         <td>{{< SecureTransport/componentlongname  >}} Login Name/Account Name         </td>
      </tr>
   </tbody>
</table>
...
<th class="HeadD-Column1-Header1">Description         </th>
   ...
   <tbody>
      <tr>
         ...
         <td><p>integer</p>         </td>
         <td>Number of active accounts in {{< SecureTransport/securetransportname  >}}: current value is taken from the existing list in <em>Accounts &gt; Active Users</em> in {{< SecureTransport/securetransportname  >}}         </td>
      </tr>
      <tr>
...
<th class="HeadD-Column1-Header1">Description         </th>
   ...
   <tbody>
      <tr>
         <td><p>DELAY</p>         </td>
         <td>integer         </td>
         <td>Heartbeat interval set on the <em>{{< SecureTransport/companyname  >}} Sentinel Events</em> page         </td>
      </tr>
   </tbody>
</table>
