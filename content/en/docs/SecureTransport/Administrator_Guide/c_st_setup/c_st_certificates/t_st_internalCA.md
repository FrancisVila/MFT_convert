...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">For security reasons, client certificates should only be stored inside the <span>SecureTransport</span> home folder or within a sub-folder of the home folder.         </td>
      </tr>
</table>
...
-   Generating a local certificate. For detail, see [Manage local certificates and certificate signing requests](../t_st_localcertificatesandcsrs).
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">If you attempt to delete the internal CA, an alert dialog box is displayed. <br/>If the certificate of the internal CA is deleted the Validation Status of all X509 local certificates, as well as imported SSH keys (because they are converted to X509 certificates during the import,) become <code>Not chained to a trusted root</code>. This has critical impact on the generated Login Certificates because users are no longer able to log into the <span>SecureTransport</span> Server.         </td>
      </tr>
</table>
...
## <span id="View_internal"></span>View the internal CA
...
## <span id="Generate_internal"></span>Generate an internal CA
...
4.  Provide the required information for the internal certificate.  
    ...
    -   <table cellpadding="0" cellspacing="0">   <col/>   <col/>   <col/>      <tr>         <td valign="top">         </td>         <td valign="top"><span><b>Note</b></span>         </td>         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">SHA1withRSA is available for backwards compatibility, but its usage is not recommended.         </td>      </tr></table>
...
## <span id="Import_external"></span>Import an external CA
...
## <span id="Export"></span>Export the internal CA
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">The internal CA files are located in the <code>&lt;FILEDRIVEHOME&gt;/lib/certs/db</code> directory as <code>.pem</code> files. The public certificate is <code>ca-crt.pem</code>. The private key is <code>ca-key.pem</code>.         </td>
      </tr>
</table>
