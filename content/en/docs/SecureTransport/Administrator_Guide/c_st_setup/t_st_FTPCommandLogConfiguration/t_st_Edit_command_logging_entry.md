...
2.  For the entry to edit, click the Edit icon (![Edit](SaveIcon_13x13.png)) in the **Edit** column.
...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">To cancel an edit operation, select <strong>Setup &gt; Command Logging</strong> again.         </td>
      </tr>
</table>
