...
<table cellpadding="0" cellspacing="0">
   ...
   <col/>
      <tr>
         ...
         <td data-mc-autonum="&lt;b&gt;Note&lt;/b&gt;" valign="top">You can make a package manager base folder stored on a network share accessible for users of only one LDAP domain.         </td>
      </tr>
</table>
