...
You must enable the `ArchiveMaintApp` rules package in the Transaction Manager before you can use an Archive Maintenance application. For more information, see [Manage rules packages](../transaction_manager/t_st_rulesPackages.htm#EnableRulesPackage#Enable).
