...
You must enable the `UnlicensedAccountMaintApp` rules package in the Transaction Manager before you can use a Unlicensed Account Maintenance application. For more information, see [Manage rules packages](../transaction_manager/t_st_rulesPackages.htm#EnableRulesPackage#Enable).
