...
You must enable the `BasicApp` *rules package* in the Transaction Manager before you can use a Basic Application. See [Manage rules packages](../transaction_manager/t_st_rulesPackages.htm#EnableRulesPackage#Enable).
