{
    "title": "Basic Application application",
...
You must enable the `BasicApp` *rules package* in the Transaction Manager before you can use a Basic Application. See [Manage rules packages](../../c_st_setup/c_st_tm_settings/t_st_rulespackages).
