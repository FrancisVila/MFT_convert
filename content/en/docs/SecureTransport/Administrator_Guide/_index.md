{
    "title": "SecureTransport 5.5 Administrator Guide",
    "linkTitle": "SecureTransport 5.5 Administrator Guide",
    "weight": "20"
}The SecureTransport Administrator Guide describes how to administer and manage the <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> Administration Tool. Also referred to as the <span class="mc-variable axway_variables.Component_Short_Name variable">SecureTransport</span> Admin Guide, the content of this guide is available in the Administration Tool embedded help as well.
...
Document version: <span class="mc-variable System.LongDate variable">Wednesday, November 10, 2021</span> <span class="mc-variable System.ShortTime variable">5:47 PM</span>
