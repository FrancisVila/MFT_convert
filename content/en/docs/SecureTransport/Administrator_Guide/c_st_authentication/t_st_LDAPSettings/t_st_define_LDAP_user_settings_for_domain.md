{
    ...
    "weight": "330"
}{{< SecureTransport/componentshortname  >}} uses these default values when the LDAP entry does not include the attribute and no mapping to the attribute is enabled in the *Default Attributes List*. For information, see [LDAP logins](../../c_st_ldap_logins#LDAP).
