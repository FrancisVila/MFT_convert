...
After you initialize the Mailbox for the first time and then optimize the Mailbox, you can use the <span class="code" style="font-weight: bold;">pelmon</span> command to perform Mailbox management operations:
