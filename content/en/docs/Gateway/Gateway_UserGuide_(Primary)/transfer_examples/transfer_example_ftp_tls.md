...
-   TLS Security Profile. See the [Security Guide](#) for further information (requires login)
...
See *Security Guide &gt; [Importing a Certificate](#)* for further information.
...
3.  In the<span style="font-style: italic;"> New TLS Profile</span> window, complete the <span style="font-weight: bold;">General</span> tab fields as follows:
    ...
    -   Enter the <span style="font-weight: bold;">certificate name</span>.
        ...
        See *Security Guide > Managing TLS > [Managing TLS Security Profiles](#)* for further information (requires login).
...
-   Network Profile. See *Security guide >* [Managing Network Profiles](#) for further information (requires login).
-   TLS Profile. See *Security guide >* [SSL and TLS protocols](#) for further information.
...
See the *Security Guide &gt; [Importing a Certificate](#)* for further information (requires login).
...
4.  Enter the certificate name. Use the <img src="/Images/Gateway/Certificate.gif" width="16" height="16" /> icon to browse the certificate list if you do not know the name of the certificate.
    See the *Security Guide >* [Managing Certificates](#) for further information.
...
See the *Security Guide &gt; [Managing certificates](#)* for further information (requires login).
