...
<li>The maximum number of connection retries is reached</li>
      ...
      <tr>
         ...
         <td><p>Specify the maximum interval between connection retries. The value that you enter here must be greater than or equal to the value entered in the <strong>Time before first retry</strong> field.<br />
