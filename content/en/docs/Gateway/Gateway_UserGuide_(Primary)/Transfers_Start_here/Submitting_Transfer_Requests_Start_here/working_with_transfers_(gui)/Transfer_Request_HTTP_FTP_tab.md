...
<ul>
<li><strong>FTP:</strong> Send special remote commands or unsupported FTP commands to the remote server before or after the Transfer. <span class="code">SITE</span>, <span class="code">QUOTE</span> and <span class="code">SCRIPT</span> commands are supported.
<ul>
