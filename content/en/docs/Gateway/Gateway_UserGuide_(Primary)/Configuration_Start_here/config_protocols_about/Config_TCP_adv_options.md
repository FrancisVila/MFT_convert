...
Gateway opens the <span style="font-style: italic;">TCP advanced options</span> window if you click the <span style="font-weight: bold;">Advanced...</span> button when configuring any protocol that uses TCP/IP.
