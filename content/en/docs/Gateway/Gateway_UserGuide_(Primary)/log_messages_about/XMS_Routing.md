...
<table>
   ...
   <tbody>
      ...
      <tr>
         <td><p>Action</p>         </td>
         <td><p>Check the <span style="font-style: italic;">write</span> rights or check for adequate disc space.</p>         </td>
      </tr>
   </tbody>
</table>
...
<table>
   ...
   <tbody>
      ...
      <tr>
         <td><p>Meaning</p>         </td>
         <td><p>The <span style="font-style: italic;">replyToQmgr</span> field in the header of the message to be processed is empty.</p>         </td>
      </tr>
      <tr>
         <td><p>Action</p>         </td>
