...
<table>
   ...
   <tbody>
      ...
      <tr>
         <td><p>Action</p>         </td>
         <td><p>Correct Transfer Request direction attribute and resubmit Transfer Request, or use an alternate DEA ID via the <code>peltrans tpm_dea_id</code> command.</p>         </td>
      </tr>
   </tbody>
</table>
