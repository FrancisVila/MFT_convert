...
Diagnostic codes related to data integrity, that are set as `last_end_diag `on transfers failed due to data integrity errors:
...
<table>
   ...
   <tbody>
      <tr>
         ...
         <td><p><strong>INT E KEYERR Couldn't load key from file '%1'</strong></p>         </td>
      </tr>
      <tr>
         <td><p>Type</p>         </td>
         <td><p>Error</p>         </td>
