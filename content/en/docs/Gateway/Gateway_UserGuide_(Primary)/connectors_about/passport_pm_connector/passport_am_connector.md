...
PassPort AM (Access Management) centralizes the management of users for all products of the {{< Gateway/platformorsuiteshortname  >}}. If you have installed PassPort AM, you can use it to define all your users and profiles. Gateway can then connect to PassPort AM to check user permissions.
