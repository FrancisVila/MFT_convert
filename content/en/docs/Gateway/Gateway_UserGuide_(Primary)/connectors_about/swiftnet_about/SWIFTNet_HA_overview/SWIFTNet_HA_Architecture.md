...
For purging the HA database transfer entries, use the `pelpur` subcommand [`pelpur clean_swha_db`](../../../../transfers_start_here/submitting_transfer_requests_start_here/working_with_transfers_cli#Purging).
