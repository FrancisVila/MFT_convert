...
If you have both HeaderInfo and SignatureList in the same file, and you want to use them both, use the **Additional params** parameter to specify the file. If you only want to use the HeaderInfo information from the file, use the <span style="font-weight: bold;">Header info</span> parameter.
