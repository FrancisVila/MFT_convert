...
Before you configure {{< Gateway/solutionlongname  >}} to handle TARGET2 exchanges you should be familiar with the SWIFT TARGET2 documentation. We specifically recommend the following SWIFT documents that you can obtain from www.swift.com:
