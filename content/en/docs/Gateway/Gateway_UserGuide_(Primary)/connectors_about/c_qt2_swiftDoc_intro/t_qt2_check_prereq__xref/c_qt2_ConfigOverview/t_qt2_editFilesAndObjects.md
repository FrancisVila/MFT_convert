{
    ...
    "weight": "320"
}**Prerequisite:** Install the TARGET2 package as described in the *Installation Guide &gt;* .

Configure Axway Gateway for TARGET2 as follows:

1.  Edit the `cl_objCRISTAL` script file which is located in the directory `qt2/objExport/`. In this file, set values for the following parameters that correspond to your network configuration:
