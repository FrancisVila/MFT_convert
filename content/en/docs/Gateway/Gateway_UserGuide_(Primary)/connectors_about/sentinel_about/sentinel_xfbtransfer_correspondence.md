...
-   *Axway Sentinel*: This column displays the names of the XFBTransfer attributes in alphabetical order.
-   *<span class="mc-variable axway_variables.Component_Long_Name variable">Axway Gateway</span>*: For the attributes in the *Axway Sentinel* column, this column displays the names of the corresponding Gateway properties.
...
<th class="HeadD-Column1-Header1">{{< Gateway/componentlongname  >}}         </th>
      </tr>
   </thead>
   <tbody>
      <tr>
      ...
      <tr>
         ...
         <td><p>Depends on<code> type</code></p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td><p>Date from<code> hist_create_date</code></p>         </td>
      </tr>
      <tr>
         <td><p>CreationTime</p>         </td>
         <td><p>Time from<code> hist_create_date</code></p>         </td>
      </tr>
      <tr>
         <td><p>CycleId</p>         </td>
      ...
      <tr>
         ...
         <td><p>Date from<code> date_to_begin</code></p>         </td>
      </tr>
      <tr>
         <td><p>EarliestTime</p>         </td>
         <td><p>Time from<code> date_to_begin</code></p>         </td>
      </tr>
      <tr>
         <td><p>EndDate</p>         </td>
         <td><p>Date from<code> date_to_end</code></p>         </td>
      </tr>
      <tr>
         <td><p>EndTime</p>         </td>
         <td><p>Time from<code> date_to_end</code></p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td><p>FileName</p>         </td>
         <td><p>Built from<code> dir_path</code> and<code> file_component</code></p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td><p>IsEnd</p>         </td>
         <td><ul>
<li><code>1</code> if<code> state</code> is<code> ACKED</code> or<code> ENDED</code></li>
<li><code>0</code> otherwise</li>
      ...
      <tr>
         <td><p>IsSSL</p>         </td>
         <td><ul>
<li><code>1</code> if<code> tls_sprof</code> is set</li>
<li><code>0</code> otherwise</li>
</ul>         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td><p>Machine</p>         </td>
         <td><p><code>"GTW-UNIX"</code> or<code> "GTW-NT"</code></p>         </td>
      </tr>
      <tr>
         <td><p>Monitor</p>         </td>
         <td><p>"GTW"</p>         </td>
      ...
      <tr>
         ...
         <td><p><code>sentinel_product_ip_addr</code> (configuration parameter)</p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td><p><code>rcv_msg</code> or<code> snd_msg (</code>if the transfer is of type message)</p>
<p>Note: on PeSIT, only the message sent in transfer-related phases is visible in the tracked object updates sent to Sentinel</p>         </td>
      ...
      <tr>
         ...
         <td><p><code>rcv_msg</code> or<code> snd_msg</code> (if the transfer is of type transfer). See note for ProtocolMessage above.</p>         </td>
      </tr>
      <tr>
         <td><p>ProtocolSelectParameter</p>         </td>
         <td><p><code>rcv_msg</code> (if the transfer is: outgoing, PeSit or SWIFTNet, and of type transfer). See note for ProtocolMessage above.</p>         </td>
      </tr>
      <tr>
         <td><p>RAppl</p>         </td>
         <td><p>rcv_appli</p>         </td>
      ...
      <tr>
         ...
         <td><p><code>remote_agent_ident</code> or<code> local_agent_ident</code></p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td><p>Date from<code> date_create</code></p>         </td>
      </tr>
      <tr>
         <td><p>RequestCreationTime</p>         </td>
         <td><p>Time from<code> date_create</code></p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td><p><code>last_end_reason</code>, <code>last_end_diag</code>, and <code>last_end_err</code></p>         </td>
      </tr>
      <tr>
         <td><p>ReturnMessage</p>         </td>
         <td><p>Message corresponding to<code> last_end_reason</code></p>         </td>
      </tr>
      <tr>
         <td><p>RUser</p>         </td>
         <td><p>rcv_user</p>         </td>
      ...
      <tr>
         <td><p>SSLAuth</p>         </td>
         <td><ul>
<li>"Serveur" if<code> tls_server_auth</code> is set</li>
<li>"Both" if<code> tls_server_auth</code> and<code> tls_client_auth</code> are set</li>
<li>"None" otherwise</li>
      ...
      <tr>
         <td><p>State</p>         </td>
         <td><p>Combination of: <code>state</code>, <code>direction</code>, <code>mode</code>, <code>user_processed</code> and <code>route_state</code>.</p>         </td>
      </tr>
      <tr>
         <td><p>SUser</p>         </td>
         <td><p>snd_user</p>         </td>
      ...
      <tr>
         ...
         <td><p><code>data_code</code>, plus<code> "T"</code> if<code> xfer_data_code</code> is not equal to<code> data_code</code>, in other words when there is transcoding</p>         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td><p><code>f(date_end – date_begin)</code></p>         </td>
      </tr>
      <tr>
