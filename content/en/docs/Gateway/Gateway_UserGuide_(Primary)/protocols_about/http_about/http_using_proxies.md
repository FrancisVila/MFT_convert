...
The configuration of a Proxy object is defined in the file `proxy.ini`.

To use a Proxy, add `@proxy_name`to the TCP address of the Remote Site.

The TCP address of Sites (`IP@proxy/port`) must not exceed 63 characters.
